...
from Test_w_02_Palette_Complete_Your_Reserve.Page.CC_CreativePage import CC_CreativePage
...
class W_02_Palette_Complete_Your_Reservation_Page_Test(unittest.TestCase):
    ...
    def test_b1_Hero_Sub_HeaderText1_Validation(self):
        logger.info(': ' + self.test_b1_Hero_Sub_HeaderText1_Validation.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_b1_Hero_Header_lineText_validation()

    def test_b2_Hero_Subcopy_Validation(self):
        logger.info(': ' + self.test_b2_Hero_Subcopy_Validation.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_b2_Hero_Subcopy_validation()

    def test_c1_Module2_DownloadApp_link_verification(self):
        logger.info(': ' + self.test_c1_Module2_DownloadApp_link_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Module2_DownloadApp_link_validation()

    def test_c2_Module2_Subcopy_verification(self):
        logger.info(': ' + self.test_c2_Module2_Subcopy_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_b2_Module2_Subcopy2_validation()
    ...
    # def test_a2_Text_Validation(self):
    #     logger.info(': ' + self.test_a2_Text_Validation.__name__)
    #     ccpage=CC_CreativePage(self.driver)
    #     ccpage.get_CC_a2_text_validation()
    #
    # def test_a3_Text_Validation(self):
    #     logger.info(': ' + self.test_a3_Text_Validation.__name__)
    #     ccpage=CC_CreativePage(self.driver)
    #     ccpage.get_CC_a3_text_validation()
