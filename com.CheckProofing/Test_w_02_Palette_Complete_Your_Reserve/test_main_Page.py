...
from Test_w_02_Palette_Complete_Your_Reserve.test_w02_Palette_Complete_Your_Reservation_Email_Page import W_02_Palette_Complete_Your_Reservation_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_02_Palette_Complete_Your_Reservation_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_02_Palette_Complete_Your_Reservation_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
