...
class webPage_W_42_S20_S6_S8_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w42_S20FE_configData('S20FE_S6_S8_Data', 'url') in url:
    ...
    def test_a_S20FE_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_S6_S8_Data', 'url'), WebPage_URL,
    ...
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w42_S20FE_configData('WEBPage', 'instant_credit'), instant_price,
    #                   msg="Instant Credit is not Matched. ")
    #     logger.info(": Successfully verified Instant Credit: " + ReadConfig.read_w42_S20FE_configData('WEBPage',
    #                                                                                                   'instant_credit'))
    #     logger.info('####  TEST Complete  ####')
