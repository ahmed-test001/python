...
from Test_w_42_S20FE_LastChanceT2.test_w_42_S20FE_GENERIC_HTML_Page import HTMLPage_W_42_S20_GENERIC_Test
from Test_w_42_S20FE_LastChanceT2.test_w_42_S20FE_GEN_URL_segment import URLSegment_W_42_S20_GEN_Test
from Test_w_42_S20FE_LastChanceT2.test_w_42_S20FE_GEN_WEB_page import webPage_W_42_S20_GEN_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_42_S20_GENERIC_Test, webPage_W_42_S20_GEN_Test, URLSegment_W_42_S20_GEN_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_S20FE_GEN_1_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
