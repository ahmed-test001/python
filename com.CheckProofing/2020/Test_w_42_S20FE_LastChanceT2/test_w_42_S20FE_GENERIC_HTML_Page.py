...
class HTMLPage_W_42_S20_GENERIC_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data','html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'subject_line'))
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
        logger.info(": Pre-Header text assert with : " + pheaderTxt)
        logger.info('####  TEST Complete  ####')

    def test_c_S20_Hero_BuyNow_link_validation(self):
        logger.info(': '+self.test_c_S20_Hero_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        ...
        self.method_list_in_Url.append(self.test_c_S20_Hero_BuyNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_d_S20_GalaxyEcoSystem_BuyNow_link_validation(self):
        logger.info(': '+self.test_d_S20_GalaxyEcoSystem_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1034']")
        linkT.click()
        time.sleep(2)
        ...
        time.sleep(1)
        self.url_list.append(Buy_Now_URL)
        self.method_list_in_Url.append(self.test_d_S20_GalaxyEcoSystem_BuyNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
    ...
    # def test_e_S20_FE5G_PreOrderNow_link_validation(self):
    #     logger.info(': '+self.test_e_S20_FE5G_PreOrderNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
    #     parent_window = self.driver.current_window_handle
    #     linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1034']")
    #     linkT.click()
    #     time.sleep(2)
    ...
    #     self.driver.switch_to.window(child_window)
    #     time.sleep(5)
    #     PreOrder_Now_URL = self.driver.current_url
    #     time.sleep(1)
    #     self.url_list.append(PreOrder_Now_URL)
    #     self.method_list_in_Url.append(self.test_e_S20_FE5G_PreOrderNow_link_validation.__name__)
    #     self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'url'), PreOrder_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
    #     self.driver.close()
    #     logger.info(": Reference URL: " + PreOrder_Now_URL)
    #     self.driver.switch_to.window(parent_window)
    #     logger.info('####  TEST Complete  ####')

    # def test_f_S20_creative_text_validation(self):
    #     logger.info(': '+self.test_f_S20_creative_text_validation.__name__ + "\n #####  Starting TEST  ##### ")
    #     time.sleep(3)
    #     Hero_SL_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Headline_Generic']").text
    #     print(Hero_SL_Txt)
    #     time.sleep(3)
    #     Hero_PH_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Subcopy_Generic']").text
    #     print(Hero_PH_Txt)
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'Hero_SL_Txt'), Hero_SL_Txt,msg="S20 Hero Subject Line Text Not Matching")
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_GEN_Data', 'Hero_PH_Txt'), Hero_PH_Txt, msg="S20 Hero Pre Header Text Not Matching")
    #     logger.info('####  TEST Complete  ####')

    def test_g_pay_later_icon_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_g_pay_later_icon_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'pay_later_url'), paylater_url, msg="Pay Later Landing Page URL is not Matched.")
        logger.info(': Assertion Pay Later with: ' + paylater_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_h_free_shipping_icon_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_h_free_shipping_icon_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShipping_url, msg="Free Shipping Landing Page URL is not Matched.")
        logger.info(': Assertion Free SHipping with: ' + freeShipping_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_i_GetRewarded_icon_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_i_GetRewarded_icon_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url, msg="Get Rewarded Landing Page URL is not Matched.")
        logger.info(': Assertion Free SHipping with: ' + getRewarded_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_j_google_play_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_j_google_play_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'google_play_url'), googleApp_url, msg="Google Play store Page URL Not Matched.")
        logger.info(': Assertion Free Google Play App with: ' + googleApp_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_k_apple_store_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_k_apple_store_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'apple_url'), appleApp_url, msg="Apple App Page URL Not Matched.")
        logger.info(': Assertion Free Apple App with: ' + appleApp_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_l_free_shipping_details_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_l_free_shipping_details_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url, msg="Free Shipping Page URL Not Matched.")
        logger.info(': Assertion Free Ship Button URL with: ' + freeShip_button_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_m_Mobile_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_m_Mobile_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'mobile_button_url'), mobile_button_url, msg="Mobile Page URL Not Matched.")
    ...
    def test_n_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url, msg="TV & Audio Page URL Not Matched.")
    ...
    def test_o_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'computing_button_url'), Computing_button_url, msg="Computing Page URL Not Matched.")
    ...
    def test_p_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url, msg="Appliance Page URL Not Matched.")
    ...
    def test_q_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'weekly_offer_button_url'), WeeklyOffer_button_url, msg="Weekly Offer Page URL Not Matched.")
    ...
    def test_r_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'facebook_url'), Facebook_button_url, msg="Facebook Page URL Not Matched.")
    ...
    def test_s_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'instagram_url'), Instagram_button_url, msg="Instagram Page URL Not Matched.")
    ...
    def test_t_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'twitter_url'), Twitter_button_url, msg="Twitter Page URL Not Matched.")
    ...
    def test_u_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_S20FE_configData('EMAILPage', 'youtube_url'), Youtube_button_url, msg="Youtube Page URL Not Matched.")
    ...
    def test_v_collect_unique_URL_with_method_Name(self):
        logger.info(' ##### ' + self.test_v_collect_unique_URL_with_method_Name.__name__ + "\n #####  Starting TEST  ##### ")
    ...
    def test_w_get_unique_URL_list(self):
        logger.info(' ##### ' + self.test_w_get_unique_URL_list.__name__ + "\n #####  Starting TEST  ##### ")
