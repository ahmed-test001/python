...
class HTMLPage_W_42_S20_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data','html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'subject_line'))
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_c_S20_Hero_BuyNow_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
    ...
    #     self.assertEqual(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'url'), PreOrder_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
    #     self.driver.close()
    ...
    #     time.sleep(3)
    #     Hero_SL_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Headline_EPP_Reserve']").text
    #     print(Hero_SL_Txt)
    #     time.sleep(3)
    #     Hero_PH_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Subcopy_EPP_Reserve']").text
    #     print(Hero_PH_Txt)
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'Hero_SL_Txt'), Hero_SL_Txt,msg="S20 Hero Subject Line Text Not Matching")
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w42_S20FE_configData('S20FE_EPP_Data', 'Hero_PH_Txt'), Hero_PH_Txt, msg="S20 Hero Pre Header Text Not Matching")
    #     logger.info('####  TEST Complete  ####')
