...
from Test_w_43_TVDeals_T2.Page.url_segment_EPP_Gift import url_segment, segment_validation
...
class HTMLPage_W_43_TVDeals_EPP_Gift_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w43_TVDealsT2_configData('TVDataEPP_Gift','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w43_TVDealsT2_configData('TVDataEPP_Gift', 'subject_line'), subjectlineTxt,msg="Subject Line Text Not Matching")
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w43_TVDealsT2_configData('TVDataEPP_Gift', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w43_TVDealsT2_configData('TVDataEPP_Gift', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_h1_GiftShopnow_link_validation(self):
        logger.info(': '+self.test_h1_GiftShopnow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        ShopNow_URL = self.driver.current_url
        self.url_list.append(ShopNow_URL)
        self.method_list_in_Url.append(self.test_h1_GiftShopnow_link_validation.__name__)
        self.assertIn(ReadConfig.read_w43_TVDealsT2_configData('HtmlLink', 'giftshopnow'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+ShopNow_URL+'\n')
        with open('../Test_w_43_TVDeals_T2/URLFolder/UniqueList.txt', 'w')as f:f.writelines(ShopNow_URL)
        url_segment()
        segment_validation()
