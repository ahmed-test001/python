...
from Test_w_43_TVDeals_T2.Page.url_segment_GEN_Holiday import url_segment, segment_validation
...
class HTMLPage_W_43_TVDeals_GEN_Holiday_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w43_TVDealsT2_configData('TVDataGEN_Holiday','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w43_TVDealsT2_configData('TVDataGEN_Holiday', 'subject_line'), subjectlineTxt, msg="Subject Line Text Not Matching")
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w43_TVDealsT2_configData('TVDataGEN_Holiday', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w43_TVDealsT2_configData('TVDataGEN_Holiday', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
