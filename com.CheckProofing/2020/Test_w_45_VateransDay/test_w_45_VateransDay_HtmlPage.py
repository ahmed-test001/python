...
class HTMLPage_W_45_VateransDay_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w45_VateransDay_configData('DATA','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w45_VateransDay_configData('DATA', 'subject_line'), subjectlineTxt, msg="Subject Line Text Not Matching")
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w45_VateransDay_configData('DATA', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w45_VateransDay_configData('DATA', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Pre_Header_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a4_VaternsDay_Hero_ShopNow_link_validation(self):
        logger.info(': '+self.test_a4_VaternsDay_Hero_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@src='http://t.info.samsungusa.com/res/samsung/32a395f97e464361479d5fe86db91b14.jpg']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        self.method_list_in_Url.append(self.test_a4_VaternsDay_Hero_ShopNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w45_VateransDay_configData('DATA', 'url'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + ShopNow_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a5_VaternsDay_SaveBigDiscount_ShopNow_link_validation(self):
        logger.info(': '+self.test_a5_VaternsDay_SaveBigDiscount_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@src='http://t.info.samsungusa.com/res/samsung/ecaf442663d5fc119cb479a511c1d9fa.jpg']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        time.sleep(1)
        self.url_list.append(ShopNow_URL)
        self.method_list_in_Url.append(self.test_a5_VaternsDay_SaveBigDiscount_ShopNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w45_VateransDay_configData('DATA', 'url'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + ShopNow_URL)
        self.driver.switch_to.window(parent_window)
    ...
    def test_a6_VaternsDay_Laundary_ShopNow_link_validation(self):
        logger.info(': '+self.test_a6_VaternsDay_Laundary_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@src='http://t.info.samsungusa.com/res/samsung/296ef60f8fdb7030f50c4ef16b873f61.jpg']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        time.sleep(1)
        self.url_list.append(ShopNow_URL)
        self.assertIn(ReadConfig.read_w45_VateransDay_configData('Creative', 'laundary'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_a7_VaternsDay_Vaccuum_ShopNow_link_validation(self):
        logger.info(': '+self.test_a7_VaternsDay_Vaccuum_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@src='http://t.info.samsungusa.com/res/samsung/9fee5f71c2776012d60a5373f1ccc41a.jpg']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        time.sleep(1)
        self.url_list.append(ShopNow_URL)
        self.assertIn(ReadConfig.read_w45_VateransDay_configData('Creative', 'vaccuum'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:" + ShopNow_URL + '\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(ShopNow_URL)
        URLSegemntPage.get_segment()
        self.driver.close()
    ...
    def test_i1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'pay_later_url'), paylater_url, msg="Pay Later Landing Page URL is not Matched.")
    ...
    def test_i2_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'free_shipping_url'), freeShipping_url, msg="Free Shipping Landing Page URL is not Matched.")
    ...
    def test_j1_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'google_play_url'), googleApp_url, msg="Google Play store Page URL Not Matched.")
    ...
    def test_j2_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'apple_url'), appleApp_url, msg="Apple App Page URL Not Matched.")
    ...
    def test_k1_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url, msg="Free Shipping Page URL Not Matched.")
    ...
    def test_k2_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'mobile_button_url'),mobile_button_url, msg="Mobile Page URL Not Matched.")
    ...
    def test_k3_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'tv_audio_button_url'),Tv_Audio_button_url, msg="TV & Audio Page URL Not Matched.")
    ...
    def test_k4_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'computing_button_url'),Computing_button_url, msg="Computing Page URL Not Matched.")
    ...
    def test_k5_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url, msg="Appliance Page URL Not Matched.")
    ...
    def test_k6_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'weekly_offer_button_url'), WeeklyOffer_button_url, msg="Weekly Offer Page URL Not Matched.")
    ...
    def test_l1_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'facebook_url'), Facebook_button_url, msg="Facebook Page URL Not Matched.")
    ...
    def test_l2_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'instagram_url'),Instagram_button_url, msg="Instagram Page URL Not Matched.")
    ...
    def test_l3_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'twitter_url'), Twitter_button_url,msg="Twitter Page URL Not Matched.")
    ...
    def test_l4_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('EMAILPage', 'youtube_url'), Youtube_button_url,msg="Youtube Page URL Not Matched.")
