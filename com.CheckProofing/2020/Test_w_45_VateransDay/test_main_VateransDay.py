...
from Test_w_45_VateransDay.test_w_45_VateransDay_HtmlPage import HTMLPage_W_45_VateransDay_Test
from Test_w_45_VateransDay.test_w_45_VateransDay_URLSegment import URLSegment_W_45_VateransDay_Test
from Test_w_45_VateransDay.test_w_45_Vaterans_WebPage import webPage_W_45_VateransDay_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_45_VateransDay_Test, webPage_W_45_VateransDay_Test, URLSegment_W_45_VateransDay_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W45_VATERANSDAY_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
