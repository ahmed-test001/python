...
from Test_w_40_Wearable.test_w_40_Wearable_HTML_page import HTMLPage_W_40_WearableTest
from Test_w_40_Wearable.test_w_40_Wearable_URL_segment import URLSegment_W_40_WearableTest
from Test_w_40_Wearable.test_w_40_Wearable_WEB_page import webPage_W_40_WearableTest
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_40_WearableTest, webPage_W_40_WearableTest, URLSegment_W_40_WearableTest]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_WEARABLE_4_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
