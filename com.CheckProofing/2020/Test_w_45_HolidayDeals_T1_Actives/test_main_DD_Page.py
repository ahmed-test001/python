...
from Test_w_45_HolidayDeals_T1_Actives.test_w45_DD_Modules_verification_Page import W_45_DD_Module_Verify_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[W_45_DD_Module_Verify_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W_45_DD_Modules_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
