...
from Test_w_42_PrimeDay_Disrupt.test_w_42_PrimeDay_EPP_HtmlPage import HTMLPage_W_42_PrimeDay_EPP_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_42_PrimeDay_EPP_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "PRIMEDAY_W42_ReportEPP_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
