...
class HTMLPage_W_42_PrimeDay_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_PrimeDay_configData('PrimeDataEPP','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_PrimeDay_configData('PrimeDataEPP', 'subject_line'), subjectlineTxt, msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_PrimeDay_configData('PrimeDataEPP', 'subject_line'))
        logger.info('\n ####  TEST Complete  ####')
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_PrimeDay_configData('PrimeDataEPP', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_PrimeDay_configData('PrimeDataEPP', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_e5_galaxyS20ultra_BuyNow_link_validation(self):
        ...
        self.driver.switch_to.window(child_window)
        time.sleep(3)
        # self.wait.until(EC.url_changes(ReadConfig.read_w42_PrimeDay_configData('WEBLink', 's20ultra')))
        Buy_Now_URL = self.driver.current_url
        self.url_list.append(Buy_Now_URL)
    ...
    def test_e6_galaxyNote20_BuyNow_link_validation(self):
        ...
        self.driver.switch_to.window(child_window)
        time.sleep(3)
        # self.wait.until(EC.url_contains(ReadConfig.read_w42_PrimeDay_configData('WEBLink', 'note20')))
        Buy_Now_URL = self.driver.current_url
        self.url_list.append(Buy_Now_URL)
    ...
    def test_g8_CleaneStation_BuyNow_link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='_x0000_i1065']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
    ...
    def test_h1_SignUpSavings_link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@id='_x0000_i1067']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
