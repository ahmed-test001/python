...
from Test_w_49_CyberWeek_T3.Page.CC_CreativePage import CC_CreativePage
...
class W_49_CyberWeek_T3_ProofingValidationPage_Test(unittest.TestCase):
    ...
    def test_c3_Dynamic_ModuleLink_Validation(self):
        ...
        if "CC" in self.url:
            if "TV" in self.url:
                ...
                HApage.get_HomeAppliance_Module5()
