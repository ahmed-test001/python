...
from Test_w_48_Holiday_BF_All_Week_Long.Page.All_CreativePage import All_CreativePage
...
class W_48_BF_ALL_ProofingValidationPage_Test(unittest.TestCase):
    ...
    def test_a1_Top_Hero_verification(self):
        ...
        if "All" in self.url:
            ccpage=All_CreativePage(self.driver)
