...
from Test_w_48_Holiday_BF_All_Week_Long.Page.DD_CreativePage import DD_CreativePage
...
class W_48_BF_DD_ProofingValidationPage_Test(unittest.TestCase):
    url_path = ""
    url = ""
    driver = None
    url_list = []
