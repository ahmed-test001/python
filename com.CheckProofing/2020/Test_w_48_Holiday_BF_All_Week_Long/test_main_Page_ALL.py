...
from Test_w_48_Holiday_BF_All_Week_Long.test_w48_BF_ALL_ProofingValidationPage import W_48_BF_ALL_ProofingValidationPage_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[W_48_BF_ALL_ProofingValidationPage_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "All_1_W_48_BF_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
