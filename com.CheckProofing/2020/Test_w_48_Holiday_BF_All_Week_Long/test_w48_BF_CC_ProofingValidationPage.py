...
from Test_w_48_Holiday_BF_All_Week_Long.Page.CC_CreativePage import CC_CreativePage
...
class W_48_BF_CC_ProofingValidationPage_Test(unittest.TestCase):
    ...
    def test_a6_Module1_SubHeadLineText_Validation(self):
        logger.info(': ' + self.test_a6_Module1_SubHeadLineText_Validation.__name__)
        if "CC" in self.url:
    ...
    def test_b3_Dynamic_Module_Validation(self):
        logger.info(': ' + self.test_b3_Dynamic_Module_Validation.__name__)
