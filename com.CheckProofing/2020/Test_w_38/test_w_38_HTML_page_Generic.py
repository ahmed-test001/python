...
class HTMLPageGenericTest(unittest.TestCase):
    driver = None
    url_list=[]
    method_list_in_Url=[]
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w38_configData('Generic', 'html_path_Gen'))
    ...
    def test_a_pre_header_text_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'pre_headertext_Generic') in linkT
    ...
    def test_b_get_sub_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url2
        self.driver.close()
    ...
    def test_c_get_galaxyNote20_eligible_tradein_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url3
        self.driver.close()
    ...
    def test_e_redeem_instant_credit_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url5
        self.driver.close()
    ...
    def test_f_get_great_pricing_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url6
        self.driver.close()
    ...
    def test_g_get_your_tradein_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url7
        self.driver.close()
    ...
    def test_h_50prcntOff_unlock_galaxyNote20_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url8
        self.driver.close()
    ...
    def test_i_powerPhone_WorknPlay_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url9
        self.driver.close()
    ...
    def test_j_crackedScreen_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url10
        self.driver.close()
    ...
    def test_k_galaxyG_fold2_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url11
        self.driver.close()
    ...
    def test_l_galaxy_TabS7_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('Generic', 'url_Gen') in url12
        self.driver.close()
