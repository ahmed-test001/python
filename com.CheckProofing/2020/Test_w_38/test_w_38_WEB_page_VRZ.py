...
class webPageVRZTest(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url:
    ...
    def test_b_verify_promo_credit_banner(self):
        ...
        assert ReadConfig.read_w38_configData('WEBPage', 'Promo_Credit_banner_carrier') in bannerText
