...
from Test_w_53_NewYears_Holiday_Offers_Email.test_w53_NewYear_Holiday_Offers_Email_Page import W_53_NewYear_Holiday_Offers_Email_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_53_NewYear_Holiday_Offers_Email_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_53_NewYear_Holiday_Offers_Email_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
