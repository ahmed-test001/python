...
from Test_w_46_HolidayDeals_T2.Page.w46_FooterLinkPage import W_46_FooterLinkPage
from Test_w_46_HolidayDeals_T2.Page.w46_CC_CreativePage import W46_CC_CreativePage
from Test_w_46_HolidayDeals_T2.Page.ComputingPage import ComputingPage
from Test_w_46_HolidayDeals_T2.Page.HomeAppliancePage import HomeAppliancePage
from Test_w_46_HolidayDeals_T2.Page.MobileAccessoriesPage import MobileAccessoriesPage
from Test_w_46_HolidayDeals_T2.Page.SmartPhonePage import SmartPhonePage
from Test_w_46_HolidayDeals_T2.Page.TVHomeTheaterPage import TVHomeTheaterPage
...
class W_46_CC_ProofingValidationPage_Test(unittest.TestCase):
    ...
    def test_a1_EPP_or_NonEPP_verification(self):
        ...
        if "CC" in self.url:
            ccpage=W46_CC_CreativePage(self.driver)
