...
class W46_CC_CreativePage(BasePage):
    ...
    def get_CC_subjectLine_text_validation(self):
        ...
        subjectlineTxt = self.driver.find_element_by_xpath("(//p[@class='MsoNormal'])[4]/span").text
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'cc_subject_line') in subjectlineTxt, "Subject Line Text Not Matching"
    ...
    def get_CC_pre_header_text_validation(self):
        ...
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'cc_pre_headertext') in pheaderTxt, "Pre Header Text Not Matching"
    ...
    def get_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'cc_pre_header_url') in URL, "Web Landing Page URL is not Matching."
