...
class ComputingPage(BasePage):
    ...
    def get_CE_COMPUTER_Module(self):
        ...
        if "CE_COMPUTER" in subjectlineTxt:
            ...
            assert ReadConfig.read_w46_HolidayDeals_T2_configData('DD_Module', 'monitor_url') in  Module_1_URL, "Web Landing Page URL is not Matching by Buy_Now_URL"
            ...
            assert ReadConfig.read_w46_HolidayDeals_T2_configData('DD_Module', 'SSD_url') in Module_2_URL, "Web Landing Page URL is not Matching by Buy_Now_URL"
            ...
            assert ReadConfig.read_w46_HolidayDeals_T2_configData('DD_Module', 'memory_card_url') in Module_3_URL, "Web Landing Page URL is not Matching by Buy_Now_URL"
            ...
            assert ReadConfig.read_w46_HolidayDeals_T2_configData('DD_Module', 'usb_url') in Module_4_URL, "Web Landing Page URL is not Matching by Buy_Now_URL"
    ...
    def get_Computing_ShopAll(self):
        ...
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'Deals_computing') in ShopAll_URL,"Web Landing Page URL is not Matching by Buy_Now_URL"
    ...
    def get_Computing_Module(self):
        ...
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'computing_url') in URL,"Web Landing Page URL is not Matching by Buy_Now_URL"
