...
class MobileAccessoriesPage(BasePage):
    ...
    def get_MobileAccessories_ShopAll(self):
        ...
        assert ReadConfig.read_w46_HolidayDeals_T2_configData('CC_Module', 'Deals_mobile_accessories') in ShopAll_URL,"Web Landing Page URL is not Matching by Buy_Now_URL"
