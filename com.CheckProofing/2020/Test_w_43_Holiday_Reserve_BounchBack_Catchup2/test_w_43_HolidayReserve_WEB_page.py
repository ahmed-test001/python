...
class webPage_W_43_HolidayReserve_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w43_HolidayRsv_BounchBck_Catch2_configData('RH_DATA', 'url') in url:
    ...
    def test_a_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w43_HolidayRsv_BounchBck_Catch2_configData('RH_DATA', 'url'), WebPage_URL, msg="Web Landing page URL not Matched.")
    ...
    #     time.sleep(2)
    #     self.assertIn(ReadConfig.read_w43_HolidayRsv_BounchBck_Catch2_configData('WEBPage', 'confirm_msg'), success_msg,msg="Success Message is not Matched. ")
    #     logger.info(": Successfully verified confirm message: " + ReadConfig.read_w43_HolidayRsv_BounchBck_Catch2_configData('WEBPage', 'confirm_msg'))
    #     logger.info('####  TEST Complete  ####')
