...
from Test_w_50_Holiday_Last_Minute_Deals_T1.Page.CC_CreativePage import CC_CreativePage
...
class W_50_Holiday_Last_Minute_Deals_T1_ProofingValidationPage_Test(unittest.TestCase):
