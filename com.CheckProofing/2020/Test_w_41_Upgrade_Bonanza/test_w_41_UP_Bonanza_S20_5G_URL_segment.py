...
class URLSegment_W_41_S20_5G_Test(unittest.TestCase):
    ...
    def test_segment_validation(self):
        ...
        with open('../OutputT/OutResult.json', 'r')as jsonfile:
            ...
            # if ReadConfig.read_w41_S20FE_configData('S20_5G_WEBPage', 'offerCID') in readdata['check_list'][0]['offerCID']:
            #     logger.info(": offerCID matched")
            # else:
            #     logger.info(": offerCID NOT matched")
            # if ReadConfig.read_w41_S20FE_configData('S20_5G_WEBPage', 'promoCode') in readdata['check_list'][0]['promoCode']:
            ...
            if ReadConfig.read_w41_Bonanza_configData('S20_5G_WEBPage', 'utm_campaign') in readdata['check_list'][0]['utm_campaign']:
                logger.info(": utm_campaign matched")
            else:
                logger.info(": utm_campaign NOT matched")
            if ReadConfig.read_w41_Bonanza_configData('S20_5G_WEBPage', 'marsLinkCategory') in readdata['check_list'][0]['marsLinkCategory']:
            ...
            if ReadConfig.read_w41_Bonanza_configData('S20_5G_WEBPage', 'cid') in readdata['check_list'][0]['cid']:
                logger.info(": cid matched")
            else:
                logger.info(": cid NOT matched")
            if ReadConfig.read_w41_Bonanza_configData('S20_5G_WEBPage', 'bpid') in readdata['check_list'][0]['bpid']:
