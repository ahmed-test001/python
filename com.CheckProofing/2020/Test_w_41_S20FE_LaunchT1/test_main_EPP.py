...
from Test_w_41_S20FE_LaunchT1.test_w_41_S20FE_EPP_HTML_Page import HTMLPage_W_41_S20_EPP_Test
from Test_w_41_S20FE_LaunchT1.test_w_41_S20FE_EPP_URL_segment import URLSegment_W_41_S20_EPP_Test
from Test_w_41_S20FE_LaunchT1.test_w_41_S20FE_EPP_WEB_page import webPage_W_41_S20_EPP_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_41_S20_EPP_Test, webPage_W_41_S20_EPP_Test, URLSegment_W_41_S20_EPP_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_S20FE_EPP_2_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
