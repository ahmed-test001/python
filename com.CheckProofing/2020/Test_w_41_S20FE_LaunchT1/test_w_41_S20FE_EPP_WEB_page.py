...
class webPage_W_41_S20_EPP_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w41_S20FE_configData('S20FE_EPP_Data', 'url') in url:
    ...
    def test_a_S20FE_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S20FE_configData('S20FE_EPP_Data', 'url'), WebPage_URL, msg="Web Landing page URL not Matched.")
    ...
    #     time.sleep(3)
    #     self.assertIn(ReadConfig.read_w41_S20FE_configData('WEBPage', 'tradein_price'), tradein_price, msg="Tradein Price is not Matched. ")
