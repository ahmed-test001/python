...
class URLSegment_W_41_S20_GEN_Test(unittest.TestCase):
    ...
    def test_segment_validation(self):
        ...
        with open('../OutputT/OutResult.json', 'r')as jsonfile:
            ...
            # if ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'utm_campaign') in readdata['check_list'][0]['utm_campaign']:
            #     logger.info(": utm_campaign matched")
            # else:
            #     logger.info(": utm_campaign NOT matched")
            if ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'marsLinkCategory') in readdata['check_list'][0]['marsLinkCategory']:
            ...
            if ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'cid') in readdata['check_list'][0]['cid']:
                logger.info(": cid matched")
            else:
                logger.info(": cid NOT matched")
            if ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'bpid') in readdata['check_list'][0]['bpid']:
