...
class HTMLPage_W_41_S20_GEN_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data',
                                                                                                'subject_line'))
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'pre_headertext'), pheaderTxt,
                         msg="Pre Header Text Not Matching")
    ...
    def test_c_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'url'), Pre_Header_URL,
                         msg="Web Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
    ...
    def test_d_S20FE_Hero_BuyNow_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S20FE_configData('S20FE_GEN_Data', 'url'), Buy_Now_URL,
                         msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
    ...
    def test_e_S20FE_BundleOffer_BuyNow_link_validation(self):
        logger.info(
            ': ' + self.test_e_S20FE_BundleOffer_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1034']")
        linkT.click()
        time.sleep(2)
    ...
    def test_g_S20_creative_text_validation(self):
        ...
        time.sleep(3)
        tradein_price = self.driver.find_element_by_xpath("//*[@_label='Hero_SubCopy_Generic']").text
        time.sleep(3)
        instant_credit = self.driver.find_element_by_xpath("//*[@_label='Banner_Subcopy_Generic']").text
        time.sleep(3)
        ...
        time.sleep(3)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('WEBPage', 'gen_tradein_price'), tradein_price,msg="Text Not Matching")
    ...
    def test_h_pay_later_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'pay_later_url'), paylater_url,
    ...
    def test_i_free_shipping_icon_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_i_free_shipping_icon_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShipping_url,
    ...
    def test_j_GetRewarded_icon_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_j_GetRewarded_icon_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url,
    ...
    def test_k_google_play_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_k_google_play_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'google_play_url'), googleApp_url,
    ...
    def test_l_apple_store_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_l_apple_store_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'apple_url'), appleApp_url,
    ...
    def test_m_free_shipping_details_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_m_free_shipping_details_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url,
    ...
    def test_n_Mobile_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_n_Mobile_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'mobile_button_url'), mobile_button_url,
    ...
    def test_o_TV_Audio_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_o_TV_Audio_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url,
    ...
    def test_p_computing_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_p_computing_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'computing_button_url'), Computing_button_url,
    ...
    def test_q_appliances_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_q_appliances_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url,
    ...
    def test_r_weekly_offer_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_r_weekly_offer_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'weekly_offer_button_url'),
    ...
    def test_s_facebook_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_s_facebook_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'facebook_url'), Facebook_button_url,
    ...
    def test_t_instagram_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_t_instagram_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'instagram_url'), Instagram_button_url,
    ...
    def test_u_twitter_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_u_twitter_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'twitter_url'), Twitter_button_url,
    ...
    def test_v_youtube_button_LandingPage_URL_validation(self):
        logger.info(
            ': ' + self.test_v_youtube_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S20FE_configData('EMAILPage', 'youtube_url'), Youtube_button_url,
    ...
    def test_w_collect_unique_URL_with_method_Name(self):
        logger.info(
            ' ##### ' + self.test_w_collect_unique_URL_with_method_Name.__name__ + "\n #####  Starting TEST  ##### ")
