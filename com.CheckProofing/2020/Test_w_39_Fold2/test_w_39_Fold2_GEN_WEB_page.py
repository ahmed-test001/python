...
class webPage_W_39_Fold2_Gen_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w39_Fold2_configData('Fold2Data', 'url') in url:
    ...
    def test_a_GalaxyFOld2_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_Fold2_configData('Fold2Data', 'url'), GalaxyTabS7_WebPage_URL, msg="Galaxy Fold2 Web Landing page URL not Matched.")
    ...
    def test_c_Redeem_instantcredit_option_validation(self):
        ...
        logger.info(': assertion instant credit with: ' + ReadConfig.read_w39_Fold2_configData('Fold2Webpage', 'instant_Credit'))
        time.sleep(3)
        ...
        logger.info(': assertion MOGA offer with: ' + ReadConfig.read_w39_Fold2_configData('Fold2Webpage', 'MOGA_offer'))
        time.sleep(3)
        ...
        logger.info(': assertion accessories offer with: ' + ReadConfig.read_w39_Fold2_configData('Fold2Webpage', 'accessories_offer'))
        logger.info('####  TEST Complete  ####')
