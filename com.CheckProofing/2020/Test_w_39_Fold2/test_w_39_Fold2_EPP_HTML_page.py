...
class HTMLPage_W_39_Fold2_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'subject_line'), subjectlineTxt,
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_c_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'url'), Pre_Header_URL, msg="Galaxy z Fold2 Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
    ...
    def test_d_GalaxyzFold2_Buy_Now_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'url'), Buy_Now_URL, msg="Galaxy z Fold2 Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_e_GalaxyzFold2_InstantCredit_BuyNow_Link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'url'), InstantCredit_BuyNow_Link_URL, msg="Galaxy z Fold2 Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_h_GalaxyTabS7_ReservedNow_Link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1050']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        self.assertNotEqual(ReadConfig.read_w39_Fold2_configData('Fold2EPPData', 'url'), ReservedNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Reserved_Now_URL")
        self.driver.close()
