...
from Test_w_53_Palette_Reserve_T1.Page.CC_CreativePage import CC_CreativePage
...
class W_53_Palette_Reserve_T1_Page_Test(unittest.TestCase):
    ...
    def test_a_Text_Validation(self):
        logger.info(': ' + self.test_a_Text_Validation.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_a_text_validation()

    def test_a1_Text_Validation(self):
        logger.info(': ' + self.test_a1_Text_Validation.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_a1_text_validation()
