...
class webPage_W_38_S7_GenericTest(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w38_S7_Fold2_configData('S7Generic', 'url_S7_Generic') in url:
    ...
    def test_a_verify_page_current_url(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7Generic', 'url_S7_Generic') in current_url
        logger.info(': assertion complete with: '+ current_url)
    ...
    def test_b_verify_promo_credit_banner(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Promo_Credit_banner') in bannerText
    ...
    def test_c_verify_tradein_value(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Device_Tradein_Value') in tradeinPrice
    ...
    #         assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'device_Brand') in deviceBrand
    ...
    #         assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Device_Name') in deviceName
    ...
    def test_f_verify_tradein_discount_price(self):
        ...
        try:
            ...
            assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Device_Tradein_Discount_Value') in discountPrice
    ...
    def test_g_verify_total_device_price(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Total_Price') in totalPrice
    ...
    def test_h_verify_eligible_price(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'Eligible_Tradein_Value') in eligiblePrice
    ...
    def test_i_verify_list_device_price(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'list_device_price') in listdevicePrice
    ...
    #     time.sleep(3)
    #     addtocartText1 = self.driver.find_element_by_xpath("(//div[@class ='button  PRE-ORDER'])[1]").text
    #     print(addtocartText1)
    #     addtocartText2 = self.driver.find_element_by_xpath("(//div[@class ='button  PRE-ORDER'])[2]").text
    #     print(addtocartText2)
    #     assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'ShopTypeText') in addtocartText1
    #     assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'ShopTypeText') in addtocartText2
    ...
    def test_k_verify_instant_credit(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'instant_Credit') in instantCredit
        logger.info(': assertion complete with: ' + instantCredit)
        logger.info('####  TEST Complete  ####')

    @classmethod
    def test_l_verify_MOGA_credit(self):
        logger.info(': '+self.test_l_verify_MOGA_credit.__name__ + "\n #####  Starting TEST  ##### ")
        time.sleep(3)
        MOGAText = self.driver.find_element_by_xpath("(//div[@class ='promo-text-title'])[2]").text
        assert ReadConfig.read_w38_S7_Fold2_configData('WEBPage', 'MOGAtext') in MOGAText
        logger.info(': assertion complete with: ' + MOGAText)
        logger.info('####  TEST Complete  ####')
