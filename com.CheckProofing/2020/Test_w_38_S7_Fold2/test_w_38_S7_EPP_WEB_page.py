...
class webPage_W_38_S7_EPPTest(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url:
    ...
    def test_a_verify_page_current_url(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url1
