...
class HTMLPage_W_38_S7_EPPTest(unittest.TestCase):
    driver = None
    url_list=[]
    method_list_in_Url=[]
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'html_path_S7_EPP'))
    ...
    def test_a_pre_subjectLine_text_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'subject_line_S7_EPP') in subjectlineTxt
        logger.info(": Pre-Header text assert with : " + ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'subject_line_S7_EPP'))
    ...
    def test_b_pre_header_text_validation(self):
        ...
        # assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'pre_headertext_S7_EPP') in pheaderTxt
    ...
    def test_c_get_sub_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url2
        self.driver.close()
    ...
    def test_d_get_galaxyNote20_eligible_tradein_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url3
        self.driver.close()
    ...
    def test_e_CTA_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url5
        self.driver.close()
    ...
    def test_f_get_redeem_credit_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url6
        self.driver.close()
    ...
    def test_g_powerPhone_WorknPlay_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url9
        self.driver.close()
        logger.info(": Reference URL: " + url9)
        self.driver.switch_to.window(parent_window)

    @classmethod
    def test_h_fold2_link_validation(self):
        logger.info(': '+self.test_h_fold2_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_h_fold2_link_validation.__name__)
        assert ReadConfig.read_w38_S7_Fold2_configData('S7EPP', 'url_S7_EPP') in url10
        self.driver.close()
    ...
    @classmethod
    def test_y1_fold2_CTA_validation(self):
        logger.info(': '+self.test_y1_fold2_CTA_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1043']")
        linkT.click()
        time.sleep(3)
        ...
        self.driver.switch_to.window(child_window)
        time.sleep(5)
        shoptypetxt=self.driver.find_element_by_xpath("(//*[@class='button  PRE-ORDER NOW'])[1]").text
        time.sleep(5)
