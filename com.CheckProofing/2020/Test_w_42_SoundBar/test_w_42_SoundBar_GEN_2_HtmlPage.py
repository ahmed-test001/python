...
from Test_w_42_SoundBar.Page.url_segment_2 import url_segment, segment_validation
...
class HTMLPage_W_42_SoundBar_GEN_2_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2', 'subject_line'))
        logger.info('\n ####  TEST Complete  ####')
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_b1_Hero_ShopNow_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_SoundBar_configData('SoundBarDataGEN2', 'url'), Shop_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:\n"+Shop_Now_URL+'\n')
