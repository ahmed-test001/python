...
from Test_w_42_SoundBar.test_w_42_SoundBar_GEN_1_HtmlPage import HTMLPage_W_42_SoundBar_GEN_1_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_42_SoundBar_GEN_1_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "SoundBar_1_W42_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
