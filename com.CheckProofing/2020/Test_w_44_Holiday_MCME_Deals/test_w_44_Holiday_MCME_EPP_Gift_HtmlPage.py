...
from Test_w_44_Holiday_MCME_Deals.Page.url_segment_EPP_Gift import url_segment, segment_validation
...
class HTMLPage_W_44_Holiday_MCME_EPP_Gift_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w44_Holiday_MCME_configData('TVDataEPP_Gift','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('TVDataEPP_Gift', 'subject_line'), subjectlineTxt,msg="Subject Line Text Not Matching")
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w44_Holiday_MCME_configData('TVDataEPP_Gift', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w44_Holiday_MCME_configData('TVDataEPP_Gift', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_b1_All_Deals_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'all_deals'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_b2_GalaxyBuds_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'galaxyBuds'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+Buy_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(Buy_Now_URL)
        url_segment()
        segment_validation()
    ...
    def test_b3_GalaxyBuds_Plus_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'galaxyBudsPlus'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+Buy_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(Buy_Now_URL)
        url_segment()
        segment_validation()
    ...
    def test_b4_Watches_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'watches'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+Buy_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(Buy_Now_URL)
        url_segment()
        segment_validation()
    ...
    def test_b5_Tabs_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'Tabs'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+Buy_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(Buy_Now_URL)
        url_segment()
        segment_validation()
    ...
    def test_b6_GalaxyBookFlex_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'GalaxyBookFlex'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:"+Buy_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f: f.writelines(Buy_Now_URL)
        url_segment()
        segment_validation()
    ...
    def test_b7_GiveWonder_ShopNow_link_validation(self):
        logger.info(': '+self.test_b7_GiveWonder_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_b7_GiveWonder_ShopNow_link_validation.__name__)
        self.assertIn(ReadConfig.read_w44_Holiday_MCME_configData('HtmlLink', 'giftsignup'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
