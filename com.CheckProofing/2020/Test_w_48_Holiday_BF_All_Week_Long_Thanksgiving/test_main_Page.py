...
from Test_w_48_Holiday_BF_All_Week_Long_Thanksgiving.test_w48_Thanksgiving_ProofingValidationPage import  W_48_Thanksgiving_ProofingValidationPage_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[W_48_Thanksgiving_ProofingValidationPage_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_48_Thanksgiving_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
