...
from Test_w_50_Holiday_Last_Minute_Deals_Remail_T2.Page.CC_CreativePage import CC_CreativePage
...
class W_50_Holiday_Last_Minute_Deals_Remail_T2_ProofingValidationPage_Test(unittest.TestCase):
