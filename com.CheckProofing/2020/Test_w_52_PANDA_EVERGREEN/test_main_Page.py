...
from Test_w_52_PANDA_EVERGREEN.test_w52_PANDA_EVERGREEN_Page import W_52_PANDA_EVERGREEN_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_52_PANDA_EVERGREEN_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_52_PANDA_EVERGREEN_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
