...
class HTMLPage_W_39_S7_Gen_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w39_S7_configData('S7Data', 'html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Data', 'subject_line'), subjectlineTxt,
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_S7_configData('S7Data', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    #     self.assertEqual(ReadConfig.read_w39_S7_configData('S7Data', 'url'), Pre_Header_URL, msg="SeroTV Landing Page URL is not Matching by Pre_Header_URL")
    #     self.driver.close()
    ...
    #     self.assertIn(ReadConfig.read_w39_S7_configData('S7Data', 'url'), Buy_Now_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Buy_Now_URL")
    #     self.driver.close()
    ...
    #     self.assertIn(ReadConfig.read_w39_S7_configData('S7Data', 'url'), InstantCredit_BuyNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Buy_Now_URL")
    #     self.driver.close()
    ...
    #     self.assertIn(ReadConfig.read_w39_S7_configData('S7Data', 'url'), Offer_BuyNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Buy_Now_URL")
    #     self.driver.close()
    ...
    #     self.assertNotEqual(ReadConfig.read_w39_S7_configData('S7Data', 'url'), ReservedNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Reserved_Now_URL")
    #     self.driver.close()
    ...
    #     logger.info('####  TEST Complete  ####')
    #
    # def test_v_GalaxyTabS7_promotion_text_GENericonly_validation(self):
    #     logger.info(': '+self.test_v_GalaxyTabS7_promotion_text_GENericonly_validation.__name__ + "\n #####  Starting TEST  ##### ")
    #     GENpromotionTxt = self.driver.find_element_by_xpath("(//*[@_label='Hero_Text'])[2]").text
    #     print(GENpromotionTxt)
    #     self.assertIn(ReadConfig.read_w39_S7_configData('S7Data', 'offer_text_GEN'), GENpromotionTxt, msg="Promotion Text for Generic receiver Not Matching")
