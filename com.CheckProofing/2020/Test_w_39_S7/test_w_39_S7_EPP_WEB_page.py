...
class webPage_W_39_S7_EPP_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w39_S7_configData('S7EPPData', 'url') in url:
    ...
    def test_a_GalaxyTabS7_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_S7_configData('S7EPPData', 'url'), GalaxyTabS7_WebPage_URL, msg="Galaxy Tab S7 Web Landing page URL not Matched.")
    ...
    def test_b_verify_tradein_price_validation(self):
        ...
        # assert ReadConfig.read_w39_S7_configData('S7Webpage', 'tradein1_price') in tradein1
        tradein = self.driver.find_element_by_xpath("(//div[@class ='desc'])[1]").text
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Webpage', 'tradein_price_epp'), tradein, msg="Trade-In Price not Matched.")
    ...
    def test_c_Redeem_instantcredit_option_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Webpage', 'instant_Credit'), instantCredit, msg="Trade-In Price not Matched.")
        ...
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Webpage', 'MOGA_offer'), MOGAText, msg="MOGA Offer not Matched.")
        ...
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Webpage', 'accessories_offer'), accessoriesText, msg="Accesories Offer not Matched.")
