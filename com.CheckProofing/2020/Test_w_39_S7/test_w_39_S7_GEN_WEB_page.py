...
class webPage_W_39_S7_Gen_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w39_S7_configData('S7Data', 'url') in url:
    ...
    def test_a_GalaxyTabS7_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w39_S7_configData('S7Data', 'url'), GalaxyTabS7_WebPage_URL, msg="Galaxy Tab S7 Web Landing page URL not Matched.")
    ...
    def test_b_verify_tradein_price_validation(self):
        ...
        self.assertIn(ReadConfig.read_w39_S7_configData('S7Webpage', 'tradein_price_gen'), tradein, msg="Trade-In Price not Matched.")
