...
from Test_w_51_Last_Minute_Deals_T2_Ground_Shipping_Cut_Off_Mobile.Page.CC_CreativePage import CC_CreativePage
...
class W_51_LastMinuteDeals_T2_GroundShipping_CutOff_Mobile_Page_Test(unittest.TestCase):
