...
from Test_w_51_Last_Minute_Deals_T2_Ground_Shipping_Cut_Off_Mobile.test_w51_LastMinuteDeals_T2_GroundShippingCutOff_Mobile_Page import W_51_LastMinuteDeals_T2_GroundShipping_CutOff_Mobile_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_51_LastMinuteDeals_T2_GroundShipping_CutOff_Mobile_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_51_GroundShipping_CutOff_Mobile_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
