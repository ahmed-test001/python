...
from Test_w_44_TV_SoundBar_Automation_T2.test_w_44_SoundBar_GEN_HtmlPage import HTMLPage_W_44_SoundBar_GEN_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_44_SoundBar_GEN_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W44_TVSoundBar_Automation_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
