...
class HTMLPage_W_44_SoundBar_GEN_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w44_TVSoundBar_Auto_configData('TVSoundBarDataGEN','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('TVSoundBarDataGEN', 'subject_line'), subjectlineTxt,
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w44_TVSoundBar_Auto_configData('TVSoundBarDataGEN', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w44_TVSoundBar_Auto_configData('TVSoundBarDataGEN', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
    ...
    def test_b1_Hero_ShopNow_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('TVSoundBarDataGEN', 'url'), Shop_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:\n"+Shop_Now_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f:f.writelines(Shop_Now_URL)
        url_segment()
        segment_validation()
        self.driver.close()
        self.driver.switch_to.window(parent_window)
    ...
    def test_b2_SignUpSavings_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w44_TVSoundBar_Auto_configData('WEBLink', 'signupsavings'), SignUp_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        logger.info("\nsuccessfully verified Web Landing page URL:\n"+SignUp_URL+'\n')
        with open('../TextFolder_Unique_URL/UniqueList.txt', 'w')as f:f.writelines(SignUp_URL)
        url_segment()
        segment_validation()
        self.driver.close()
        self.driver.switch_to.window(parent_window)
