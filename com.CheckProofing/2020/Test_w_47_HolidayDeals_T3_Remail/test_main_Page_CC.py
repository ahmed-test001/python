...
from Test_w_47_HolidayDeals_T3_Remail.test_w47_remail_CC_ProofingValidationPage import W_47_remail_CC_ProofingValidationPage_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[W_47_remail_CC_ProofingValidationPage_Test]
