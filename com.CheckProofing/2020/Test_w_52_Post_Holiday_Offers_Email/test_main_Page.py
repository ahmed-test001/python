...
from Test_w_52_Post_Holiday_Offers_Email.test_w52_Post_Holiday_Offers_Email_Page import W_52_Post_Holiday_Offers_Email_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_52_Post_Holiday_Offers_Email_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_52_Post_Holiday_Offers_Email_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
