...
class HTMLPage_W_40_GW3Test(unittest.TestCase):
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w40_GW3_configData('GW3Data', 'subject_line'), subjectlineTxt,
    ...
    def test_c_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w40_GW3_configData('GW3Data', 'url'), Pre_Header_URL, msg="Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Pre_Header_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_d_GW3_Hero_BuyNow_link_validation(self):
        logger.info(': '+self.test_d_GW3_Hero_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_d_GW3_Hero_BuyNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w40_GW3_configData('GW3Data', 'url'), Buy_Now_URL, msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_e_GW3_BundleOffer_BuyNow_link_validation(self):
        logger.info(': '+self.test_e_GW3_BundleOffer_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@_label='Module1_Text']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        self.method_list_in_Url.append(self.test_e_GW3_BundleOffer_BuyNow_link_validation.__name__)
    ...
    def test_f_GW3_Module2_BuyNow_link_validation(self):
        logger.info(': '+self.test_f_GW3_Module2_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(1)
        self.url_list.append(Buy_Now_Link_URL)
        self.method_list_in_Url.append(self.test_f_GW3_Module2_BuyNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w40_GW3_configData('GW3Data', 'url'), Buy_Now_Link_URL, msg="Wearable Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_Link_URL)
        self.driver.switch_to.window(parent_window)
    ...
    def test_g_GW3_creative_text_validation(self):
        logger.info(': '+self.test_g_GW3_creative_text_validation.__name__ + "\n #####  Starting TEST  ##### ")
        time.sleep(3)
        certificate_price = self.driver.find_element_by_xpath("//*[@_label='Banner_Text']").text
        print(certificate_price)
        time.sleep(3)
        trade_in_price = self.driver.find_element_by_xpath("//*[@_label='Hero_Text']").text
        print(trade_in_price)
        time.sleep(3)
        self.assertIn(ReadConfig.read_w40_GW3_configData('GW3Data', 'certificate_price'), certificate_price,msg=" Text Not Matching")
        time.sleep(3)
        self.assertIn(ReadConfig.read_w40_GW3_configData('GW3Data', 'trade_in_price'), trade_in_price, msg=" Text Not Matching")
        logger.info('####  TEST Complete  ####')
    ...
    def test_j_GetRewarded_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_GW3_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url, msg="Get Rewarded Landing Page URL is not Matched.")
    ...
    def test_n_Mobile_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_n_Mobile_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_GW3_configData('EMAILPage', 'mobile_button_url'), mobile_button_url, msg="Mobile Page URL Not Matched.")
        logger.info(': Assertion Free Ship Button URL with: ' + mobile_button_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')
