...
class HTMLPage_W_41_Fold2_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(
            ": Subject Line text assert with : " + ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'pre_headertext'), pheaderTxt,
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'url'), Pre_Header_URL,
                         msg="Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
    ...
    def test_a4_GalaxyzFold2_Buy_Now_link_validation(self):
        logger.info(
            ': ' + self.test_a4_GalaxyzFold2_Buy_Now_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.assertIn(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'url'), Buy_Now_URL,
    ...
    def test_a5_GalaxyzFold2_InstantCredit_BuyNow_Link_validation(self):
        logger.info(
            ': ' + self.test_a5_GalaxyzFold2_InstantCredit_BuyNow_Link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.assertIn(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'url'), BuyNow_Link_URL,
                      msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_a6_GalaxyzFold2_feature_BuyNow_Link_validation(self):
        logger.info(
            ': ' + self.test_a6_GalaxyzFold2_feature_BuyNow_Link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.assertIn(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 'url'), Offer_BuyNow_Link_URL,
                      msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_a7_GalaxyS20FE5G_BuyNow_Link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@id='_x0000_i1047']")
        linkT.click()
        time.sleep(2)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        self.assertIn(ReadConfig.read_w41_Fold2_configData('Fold2DataEPP', 's20_url'), BuyNow_Link_URL,
                      msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + BuyNow_Link_URL)
        self.driver.switch_to.window(parent_window)
    ...
    def test_b1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'pay_later_url'), paylater_url,
    ...
    def test_b2_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'free_shipping_url'), freeShipping_url,
    ...
    def test_b3_GetRewarded_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url,
    ...
    def test_c1_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'google_play_url'), googleApp_url,
    ...
    def test_c2_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'apple_url'), appleApp_url,
    ...
    def test_d1_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url,
    ...
    def test_d2_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'mobile_button_url'), mobile_button_url,
    ...
    def test_d3_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url,
    ...
    def test_d4_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'computing_button_url'), Computing_button_url,
    ...
    def test_d5_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url,
    ...
    def test_d6_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'weekly_offer_button_url'),
    ...
    def test_e1_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'facebook_url'), Facebook_button_url,
    ...
    def test_e2_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'instagram_url'), Instagram_button_url,
    ...
    def test_e3_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'twitter_url'), Twitter_button_url,
    ...
    def test_e4_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_Fold2_configData('EMAILPage', 'youtube_url'), Youtube_button_url,
