...
from Test_w_42_TVSoundBar_Automation.Page.url_segment import baseCLass
...
class HTMLPage_W_42_TVSoundBarAutomation_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData','html_path'))
    ...
    #     self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData', 'subject_line'), subjectlineTxt,
    #                   msg="Subject Line Text Not Matching")
    #     logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData', 'subject_line'))
    #     logger.info('\n ####  TEST Complete  ####')
    #
    ...
    #     self.assertEqual(ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('\n ####  TEST Complete  ####')

    def test_b1_Hero_ShopNow_link_validation(self):
        logger.info(': '+self.test_b1_Hero_ShopNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        Buy_Now_URL = self.driver.current_url
        self.url_list.append(Buy_Now_URL)
        self.method_list_in_Url.append(self.test_b1_Hero_ShopNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w42_TVSoundBarAutomation_configData('TVSoundBarData', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
    ...
    def test_b2_BuyNow_link_validation(self):
        logger.info(': '+self.test_b2_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[@alt='Buy now'])[1]"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
    ...
    def test_b3_BuyNow_link_validation(self):
        logger.info(': '+self.test_b3_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[@alt='Buy now'])[2]"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
    ...
    def test_b4_BuyNow_link_validation(self):
        logger.info(': '+self.test_b4_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[@alt='Buy now'])[3]"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
    ...
    def test_b5_BuyNow_link_validation(self):
        logger.info(': '+self.test_b5_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "(//*[@alt='Buy now'])[4]"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        Buy_Now_URL = self.driver.current_url
    ...
    def test_c1_All_SoundBar_Saving_validation(self):
        logger.info(': ' + self.test_c1_All_SoundBar_Saving_validation.__name__ + "\n #####  Starting TEST  ##### ")
        savingTxt = self.wait.until(EC.presence_of_element_located((By.XPATH, "(// a[@_label='Soundbar_Headln'])[1]"))).text
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q950T'), savingTxt, msg="Saving Price Not Matching")
        logger.info(": Required HW_Q950T SoundBar Price : " + ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q950T'))

        savingTxt = self.wait.until(EC.presence_of_element_located((By.XPATH, "(// a[@_label='Soundbar_Headln'])[2]"))).text
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q900T'), savingTxt, msg="Saving Price Not Matching")
        logger.info(": Required HW_Q900T SoundBar Price : " + ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q900T'))

        savingTxt = self.wait.until(EC.presence_of_element_located((By.XPATH, "(// a[@_label='Soundbar_Headln'])[3]"))).text
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_LST70T'), savingTxt, msg="Saving Price Not Matching")
        logger.info(": Required HW_LST70T SoundBar Price : " + ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_LST70T'))

        savingTxt = self.wait.until(EC.presence_of_element_located((By.XPATH, "(// a[@_label='Soundbar_Headln'])[4]"))).text
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q800T'), savingTxt, msg="Saving Price Not Matching")
        logger.info(": Required HW_Q800T SoundBar Price : " + ReadConfig.read_w42_TVSoundBarAutomation_configData('WEBPage', 'HW_Q800T'))
        logger.info('\n ####  TEST Complete  ####')
    ...
    def test_i1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        # self.driver.close()
        # self.driver.switch_to.window(parent_window)
        baseCLass.window_handle(self)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'pay_later_url'), self.paylater_url, msg="Pay Later Landing Page URL is not Matched.")
        logger.info(': Assertion Pay Later with: ' + self.paylater_url)
        logger.info('\n ####  TEST Complete  ####')
    ...
    def test_i2_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'free_shipping_url'), freeShipping_url, msg="Free Shipping Landing Page URL is not Matched.")
    ...
    def test_j1_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'google_play_url'), googleApp_url, msg="Google Play store Page URL Not Matched.")
    ...
    def test_j2_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'apple_url'), appleApp_url, msg="Apple App Page URL Not Matched.")
    ...
    def test_k1_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url, msg="Free Shipping Page URL Not Matched.")
    ...
    def test_k2_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'mobile_button_url'), mobile_button_url, msg="Mobile Page URL Not Matched.")
    ...
    def test_k3_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url, msg="TV & Audio Page URL Not Matched.")
    ...
    def test_k4_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'computing_button_url'), Computing_button_url, msg="Computing Page URL Not Matched.")
    ...
    def test_k5_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url, msg="Appliance Page URL Not Matched.")
    ...
    def test_k6_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'weekly_offer_button_url'), WeeklyOffer_button_url, msg="Weekly Offer Page URL Not Matched.")
    ...
    def test_l1_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'facebook_url'), Facebook_button_url, msg="Facebook Page URL Not Matched.")
    ...
    def test_l2_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'instagram_url'), Instagram_button_url, msg="Instagram Page URL Not Matched.")
    ...
    def test_l3_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'twitter_url'), Twitter_button_url, msg="Twitter Page URL Not Matched.")
    ...
    def test_l4_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_TVSoundBarAutomation_configData('EMAILPage', 'youtube_url'), Youtube_button_url, msg="Youtube Page URL Not Matched.")
