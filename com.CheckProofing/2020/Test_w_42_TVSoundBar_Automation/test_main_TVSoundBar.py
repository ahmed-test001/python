...
from Test_w_42_TVSoundBar_Automation.test_w_42_TVSoundBarAutomation_HtmlPage import HTMLPage_W_42_TVSoundBarAutomation_Test
from Test_w_42_TVSoundBar_Automation.test_w_42_TVSoundBarAutomation_UrlSegment import URLSegment_W_42_TVSoundBarAutomation_Test
from Test_w_42_TVSoundBar_Automation.test_w_42_TVSoundBarAutomation_WebPage import WebPage_W_42_TVSoundBarAutomation_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_42_TVSoundBarAutomation_Test, WebPage_W_42_TVSoundBarAutomation_Test, URLSegment_W_42_TVSoundBarAutomation_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W42_TVSoundBar_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
