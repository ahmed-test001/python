...
class webPage_W_45_EarlyAccess_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w45_EarlyAccess_HA_configData('DATA', 'url') in url:
    ...
    def test_a_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w45_EarlyAccess_HA_configData('DATA', 'url'), WebPage_URL, msg="Web Landing page URL not Matched.")
