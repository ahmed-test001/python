...
from Test_w_45_EarlyAccess_HA_Reserve.test_w_45_EarlyAccess_HA_HtmlPage import HTMLPage_W_45_EarlyAccess_Test
from Test_w_45_EarlyAccess_HA_Reserve.test_w_45_EarlyAccess_HA_URLSegment import URLSegment_W_45_EarlyAccess_Test
from Test_w_45_EarlyAccess_HA_Reserve.test_w_45_EarlyAccess_HA_WebPage import webPage_W_45_EarlyAccess_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_45_EarlyAccess_Test, webPage_W_45_EarlyAccess_Test, URLSegment_W_45_EarlyAccess_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W45_EarlyAccess_HA_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
