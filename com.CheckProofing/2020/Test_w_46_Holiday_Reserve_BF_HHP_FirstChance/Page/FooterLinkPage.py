...
class FooterLinkPage(BasePage):
    ...
    def get_pay_later_icon_LandingPage_URL_validation(self):
        ...
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'pay_later_url') in paylater_url,"Pay Later Landing Page URL is not Matched."
    ...
    def get_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'free_shipping_url') in freeShipping_url, "Free Shipping Landing Page URL is not Matched."
    ...
    def get_google_play_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'google_play_url') in googleApp_url, "Google Play store Page URL Not Matched."
    ...
    def get_apple_store_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'apple_url') in appleApp_url,"Apple App Page URL Not Matched."
    ...
    def get_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'free_shipping_url') in freeShip_button_url, "Free Shipping Page URL Not Matched."
    ...
    def get_Mobile_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'mobile_button_url') in mobile_button_url, "Mobile Page URL Not Matched."
    ...
    def get_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'tv_audio_button_url') in Tv_Audio_button_url, "TV & Audio Page URL Not Matched."
    ...
    def get_computing_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'computing_button_url') in Computing_button_url, "Computing Page URL Not Matched."
    ...
    def get_appliances_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'appliances_button_url') in Appliance_button_url, "Appliance Page URL Not Matched."
    ...
    def get_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'weekly_offer_button_url') in WeeklyOffer_button_url, "Weekly Offer Page URL Not Matched."
    ...
    def get_facebook_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'facebook_url')in Facebook_button_url, "Facebook Page URL Not Matched."
    ...
    def get_instagram_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'instagram_url') in Instagram_button_url, "Instagram Page URL Not Matched."
    ...
    def get_twitter_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'twitter_url') in Twitter_button_url, "Twitter Page URL Not Matched."
    ...
    def get_youtube_button_LandingPage_URL_validation(self):
        ...
        # time.sleep(5)
        assert ReadConfig.read_w46_HolidayReserve_BF_HHP_configData('EMAILPage', 'youtube_url') in Youtube_button_url, "Youtube Page URL Not Matched."
