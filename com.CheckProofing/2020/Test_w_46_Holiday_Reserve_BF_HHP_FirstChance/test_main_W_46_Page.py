...
from Test_w_46_Holiday_Reserve_BF_HHP_FirstChance.test_w46_Page2 import W_46_CC_Module_Verify2_Test
from Test_w_46_Holiday_Reserve_BF_HHP_FirstChance.test_w46_CC_Modules_verification_Page import  W_46_CC_Module_Verify_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[W_46_CC_Module_Verify2_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "W_46_HolidayReserve_BF_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
