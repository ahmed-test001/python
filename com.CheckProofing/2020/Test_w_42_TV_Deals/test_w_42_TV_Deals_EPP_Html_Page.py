...
class HTMLPage_W_42_TV_Deals_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_TVDeals_configData('TVDataEPP','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_TVDeals_configData('TVDataEPP', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_TVDeals_configData('TVDataEPP', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_TVDeals_configData('TVDataEPP', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_TVDeals_configData('TVDataEPP', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_b4_Terrace4K_BuyNow_link_validation(self):
        logger.info(': '+self.test_b4_Terrace4K_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(2)
        self.url_list.append(Buy_Now_URL)
        self.method_list_in_Url.append(self.test_b4_Terrace4K_BuyNow_link_validation.__name__)
    ...
    def test_b3_Serotv4K_BuyNow_link_validation(self):
        logger.info(': '+self.test_b3_Serotv4K_BuyNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_b3_Serotv4K_BuyNow_link_validation.__name__)
