...
class HTMLPage_W_41_HolidayReserve_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
...
#         self.assertEqual(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Pre_Header_URL")
#         self.driver.close()
...
#         self.assertEqual(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
#         self.driver.close()
#         logger.info(": Reference URL: " + Buy_Now_URL)
#         self.driver.switch_to.window(parent_window)
#         logger.info('####  TEST Complete  ####')
#
#     def test_a5_Module2_SignUpForSavings_link_validation(self):
#         logger.info(': '+self.test_a5_Module2_SignUpForSavings_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
#         parent_window = self.driver.current_window_handle
...
#         time.sleep(1)
#         self.url_list.append(Buy_Now_URL)
#         self.method_list_in_Url.append(self.test_a5_Module2_SignUpForSavings_link_validation.__name__)
#         self.assertEqual(ReadConfig.read_w41_ReserveHoliday_configData('RH_DATA', 'url'), Buy_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
#         self.driver.close()
#         logger.info(": Reference URL: " + Buy_Now_URL)
#         self.driver.switch_to.window(parent_window)
#         logger.info('####  TEST Complete  ####')
#
#     # def test_a6_Text_validation(self):
#     #     logger.info(': '+self.test_a6_Text_validation.__name__ + "\n #####  Starting TEST  ##### ")
#     #     tradeinValue = self.driver.find_element_by_xpath("(//a[@target='_blank'])[1]").text
#     #     self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('WEBPAGE', 'text'), tradeinValue, msg="Tradein value Not Matched.")
#     #     logger.info(": verified Tradein Value is : " + ReadConfig.read_w41_ReserveHoliday_configData('WEBPAGE', 'tradeinValue'))
#     #     logger.info('####  TEST Complete  ####')
#
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'pay_later_url'), paylater_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'free_shipping_url'), freeShipping_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'google_play_url'), googleApp_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'apple_url'), appleApp_url,
...
#         time.sleep(5)
#         self.assertEqual(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'mobile_button_url'), mobile_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'computing_button_url'), Computing_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'weekly_offer_button_url'),
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'facebook_url'), Facebook_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'instagram_url'), Instagram_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'twitter_url'), Twitter_button_url,
...
#         time.sleep(5)
#         self.assertIn(ReadConfig.read_w41_ReserveHoliday_configData('EMAILPage', 'youtube_url'), Youtube_button_url,
