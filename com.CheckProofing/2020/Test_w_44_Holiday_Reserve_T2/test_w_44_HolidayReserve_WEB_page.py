...
class webPage_W_44_HolidayReserve_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/TestIn_UniqueURL_List.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w44_HolidayReserveT2_configData('RH_DATA', 'url') in url:
    ...
    def test_a_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w44_HolidayReserveT2_configData('RH_DATA', 'url'), WebPage_URL, msg="Web Landing page URL not Matched.")
    ...
    def test_b_SendOffers_confirmation_validation(self):
        ...
        time.sleep(2)
        self.assertIn(ReadConfig.read_w44_HolidayReserveT2_configData('EMAILPage', 'confirm_msg'), success_msg,msg="Success Message is not Matched. ")
