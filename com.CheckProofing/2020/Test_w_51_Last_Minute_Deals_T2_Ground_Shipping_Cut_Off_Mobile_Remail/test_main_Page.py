...
from Test_w_51_Last_Minute_Deals_T2_Ground_Shipping_Cut_Off_Mobile_Remail.test_w51_GroundShippingCutOff_Mobile_Remail_Page import \
    W_51_GroundShipping_CutOff_Mobile_Remail_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_51_GroundShipping_CutOff_Mobile_Remail_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_51_GroundShipping_CutOff_Mobile_Remail_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
