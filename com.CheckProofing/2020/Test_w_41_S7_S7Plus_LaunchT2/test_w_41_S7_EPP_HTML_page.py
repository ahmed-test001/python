...
class HTMLPage_W_41_S7_EPP_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'url'), Pre_Header_URL, msg="Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
    ...
    def test_a4_GalaxyTabS7_Buy_Now_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'url'), Buy_Now_URL, msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_a5_GalaxyTabS7_InstantCredit_BuyNow_Link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'url'), InstantCredit_BuyNow_Link_URL, msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
    ...
    def test_a6_GalaxyTabS7_feature_BuyNow_Link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataEPP', 'url'), BuyNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
