...
from Test_w_41_S7_S7Plus_LaunchT2.test_w_41_S7_GEN_HTML_page import HTMLPage_W_41_S7_GEN_Test
from Test_w_41_S7_S7Plus_LaunchT2.test_w_41_S7_GEN_URL_segment import URLSegment_W_41_S7_Gen_Test
from Test_w_41_S7_S7Plus_LaunchT2.test_w_41_S7_GEN_WEB_page import webPage_W_41_S7_Gen_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_41_S7_GEN_Test, webPage_W_41_S7_Gen_Test,URLSegment_W_41_S7_Gen_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_w41_TABS7_GEN_1_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
