...
class HTMLPage_W_41_S7_GEN_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'url'), Pre_Header_URL, msg="Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Pre_Header_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a4_GalaxyTabS7_Buy_Now_link_validation(self):
        logger.info(': '+self.test_a4_GalaxyTabS7_Buy_Now_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_a4_GalaxyTabS7_Buy_Now_link_validation.__name__)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'url'), Buy_Now_URL, msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + Buy_Now_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a5_GalaxyTabS7_InstantCredit_BuyNow_Link_validation(self):
        logger.info(': '+self.test_a5_GalaxyTabS7_InstantCredit_BuyNow_Link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_a5_GalaxyTabS7_InstantCredit_BuyNow_Link_validation.__name__)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'url'), InstantCredit_BuyNow_Link_URL, msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + InstantCredit_BuyNow_Link_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a6_GalaxyTabS7_feature_BuyNow_Link_validation(self):
        logger.info(': '+self.test_a6_GalaxyTabS7_feature_BuyNow_Link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        self.method_list_in_Url.append(self.test_a6_GalaxyTabS7_feature_BuyNow_Link_validation.__name__)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('S7DataGEN', 'url'), BuyNow_Link_URL, msg="Galaxy Tab S7 Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + BuyNow_Link_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a7_GalaxyS20FE5G_BuyNow_Link_validation(self):
        logger.info(
            ': ' + self.test_a7_GalaxyS20FE5G_BuyNow_Link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(1)
        self.url_list.append(BuyNow_Link_URL)
        self.method_list_in_Url.append(self.test_a7_GalaxyS20FE5G_BuyNow_Link_validation.__name__)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('WEBPAGE', 'S20FE_url'), BuyNow_Link_URL,
                      msg="Landing Page URL is not Matching by Buy_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + BuyNow_Link_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_a8_TradeinValue_validation(self):
        logger.info(': '+self.test_a8_TradeinValue_validation.__name__ + "\n #####  Starting TEST  ##### ")
        tradeinValue = self.driver.find_element_by_xpath("(//a[@target='_blank'])[1]").text
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('WEBPAGE', 'tradeinValue'), tradeinValue, msg="Tradein value Not Matched.")
        logger.info(": verified Tradein Value is : " + ReadConfig.read_w41_S7_S7Plus_configData('WEBPAGE', 'tradeinValue'))
        logger.info('####  TEST Complete  ####')
    ...
    def test_b1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'pay_later_url'), paylater_url,
    ...
    def test_b2_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'free_shipping_url'), freeShipping_url,
    ...
    def test_b3_GetRewarded_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url,
    ...
    def test_c1_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'google_play_url'), googleApp_url,
    ...
    def test_c2_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'apple_url'), appleApp_url,
    ...
    def test_d1_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url,
    ...
    def test_d2_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'mobile_button_url'), mobile_button_url,
    ...
    def test_d3_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url,
    ...
    def test_d4_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'computing_button_url'), Computing_button_url,
    ...
    def test_d5_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url,
    ...
    def test_d6_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'weekly_offer_button_url'),
    ...
    def test_e1_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'facebook_url'), Facebook_button_url,
    ...
    def test_e2_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'instagram_url'), Instagram_button_url,
    ...
    def test_e3_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'twitter_url'), Twitter_button_url,
    ...
    def test_e4_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w41_S7_S7Plus_configData('EMAILPage', 'youtube_url'), Youtube_button_url,
