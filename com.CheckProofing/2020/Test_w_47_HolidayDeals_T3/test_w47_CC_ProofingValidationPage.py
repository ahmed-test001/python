...
from Test_w_47_HolidayDeals_T3.Page.ComputingPage import ComputingPage
from Test_w_47_HolidayDeals_T3.Page.HomeAppliancePage import HomeAppliancePage
from Test_w_47_HolidayDeals_T3.Page.MobileAccessoriesPage import MobileAccessoriesPage
from Test_w_47_HolidayDeals_T3.Page.SmartPhonePage import SmartPhonePage
from Test_w_47_HolidayDeals_T3.Page.TVHomeTheaterPage import TVHomeTheaterPage
from Test_w_47_HolidayDeals_T3.Page.w47_CC_CreativePage import W47_CC_CreativePage
from Test_w_47_HolidayDeals_T3.Page.w47_FooterLinkPage import W_47_FooterLinkPage
...
class W_47_CC_ProofingValidationPage_Test(unittest.TestCase):
    ...
    def test_a1_Top_Hero_verification(self):
        ...
        if "CC" in self.url:
            ccpage=W47_CC_CreativePage(self.driver)
    ...
    def test_b1_Dynamic_Module_Validation(self):
        ...
        if "CC" in self.url:
            if "TV" in self.url:
                ...
                print("NONE CC option got selected.")
        time.sleep(5)
    ...
    def test_i1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        footerPage=W_47_FooterLinkPage(self.driver)
