...
class utilityPage:
    ...
    #     path = 'C:/Users/a.ferdous.CORP/PycharmProjects/com.CheckProofing/Test_w_47_HolidayDeals_T3/creative/*.htm'
    ...
    #     path = 'C:/Users/a.ferdous.CORP/PycharmProjects/com.CheckProofing/Test_w_47_HolidayDeals_T3/creative2/*.htm'
    #     with open('../TextFolder_Unique_URL/UniqueList_2.txt',"w")as f:
    #         files = glob.glob(path)
    #         for x in files:
    #             # if "DD" in x:
