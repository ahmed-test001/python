...
class HTMLPage_W_42_HolidayReserve_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA','html_path'))
    ...
    def test_a1_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'subject_line'))
    ...
    def test_a2_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
    ...
    def test_a3_pre_header_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'url'), Pre_Header_URL, msg="Web Landing Page URL is not Matching by Pre_Header_URL")
        self.driver.close()
    ...
    def test_a4_Hero_SignUpForSavings_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'url'), Signup_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
    ...
    def test_a5_Module2_ShopNow_link_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w42_HolidayReserve_configData('RH_DATA', 'url'), ShopNow_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
    ...
    def test_b1_pay_later_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'pay_later_url'), paylater_url,
    ...
    def test_b2_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'free_shipping_url'), freeShipping_url,
    ...
    def test_b3_GetRewarded_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'get_rewarded_url'), getRewarded_url,
    ...
    def test_c1_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'google_play_url'), googleApp_url,
    ...
    def test_c2_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'apple_url'), appleApp_url,
    ...
    def test_d1_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url,
    ...
    def test_d2_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'mobile_button_url'), mobile_button_url,
    ...
    def test_d3_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url,
    ...
    def test_d4_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'computing_button_url'), Computing_button_url,
    ...
    def test_d5_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url,
    ...
    def test_d6_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'weekly_offer_button_url'),
    ...
    def test_e1_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'facebook_url'), Facebook_button_url,
    ...
    def test_e2_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'instagram_url'), Instagram_button_url,
    ...
    def test_e3_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'twitter_url'), Twitter_button_url,
    ...
    def test_e4_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w42_HolidayReserve_configData('EMAILPage', 'youtube_url'), Youtube_button_url,
