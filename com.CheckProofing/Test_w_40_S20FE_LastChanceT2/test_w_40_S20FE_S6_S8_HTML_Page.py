...
class HTMLPage_W_40_S20_S6_S8_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def test_f_S20_creative_text_validation(self):
        ...
        Hero_SL_Txt = self.driver.find_element_by_xpath("//*[@_label='Hero_Header']").text
        self.assertIn(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'Hero_SL_Txt'), Hero_SL_Txt, msg="S20 Hero Subject Line Text Not Matching")
        Hero_PH_Txt = self.driver.find_element_by_xpath("//*[@_label='Hero_Text']").text
        self.assertIn(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'Hero_PH_Txt'), Hero_PH_Txt, msg="S20 Hero Pre Header Text Not Matching")
        logger.info('####  TEST Complete  ####')
    ...
    def test_i_google_play_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_i_google_play_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
    ...
    def test_j_apple_store_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_j_apple_store_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
    ...
    def test_k_free_shipping_details_button_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_k_free_shipping_details_button_LandingPage_URL_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
    ...
    def test_t_collect_unique_URL_with_method_Name(self):
        logger.info(' ##### ' + self.test_t_collect_unique_URL_with_method_Name.__name__ + "\n #####  Starting TEST  ##### ")
