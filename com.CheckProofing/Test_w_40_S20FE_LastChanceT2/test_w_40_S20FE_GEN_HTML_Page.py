...
class HTMLPage_W_40_S20_GEN_Test(unittest.TestCase):
    driver = None
    url_list = []
    method_list_in_Url = []
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data','html_path'))
    ...
    def test_a_subjectLine_text_validation(self):
        ...
        self.assertIn(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'subject_line'), subjectlineTxt,
                      msg="Subject Line Text Not Matching")
        logger.info(": Subject Line text assert with : " + ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'subject_line'))
    ...
    def test_b_pre_header_text_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'pre_headertext'), pheaderTxt, msg="Pre Header Text Not Matching")
        logger.info(": Pre-Header text assert with : " + pheaderTxt)
        logger.info('####  TEST Complete  ####')

    def test_c_S20_Hero_PreOrderNow_link_validation(self):
        logger.info(': '+self.test_c_S20_Hero_PreOrderNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        ...
        self.method_list_in_Url.append(self.test_c_S20_Hero_PreOrderNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'url'), PreOrder_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + PreOrder_Now_URL)
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')

    def test_d_S20_InstantCredit_PreOrderNow_link_validation(self):
        logger.info(': '+self.test_d_S20_InstantCredit_PreOrderNow_link_validation.__name__ + "\n #####  Starting TEST  ##### ")
        parent_window = self.driver.current_window_handle
        ...
        time.sleep(1)
        self.url_list.append(PreOrder_Now_URL)
        self.method_list_in_Url.append(self.test_d_S20_InstantCredit_PreOrderNow_link_validation.__name__)
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'url'), PreOrder_Now_URL, msg="Web Landing Page URL is not Matching by Pre Order_Now_URL")
        self.driver.close()
        logger.info(": Reference URL: " + PreOrder_Now_URL)
        self.driver.switch_to.window(parent_window)
    ...
    def test_f_S20_creative_text_validation(self):
        ...
        Hero_HL_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Headline_Generic']").text
        print("Hero_SL_Txt: "+Hero_HL_Txt)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'Hero_HL_Txt'), Hero_HL_Txt, msg="S20 Hero Subject Line Text Not Matching")
        Hero_Banner_Txt = self.driver.find_element_by_xpath("//*[@_label='Banner_Subcopy_Generic']").text
        print("Hero_Banner_Txt: "+Hero_Banner_Txt)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'Hero_Banner_Txt'), Hero_Banner_Txt, msg="S20 Hero Pre Header Text Not Matching")
        logger.info('####  TEST Complete  ####')
    ...
    def test_g_pay_later_icon_LandingPage_URL_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        payover = self.driver.find_element_by_xpath("//a[@_label='Pay_Later_Title']")
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'pay_later_url'), paylater_url, msg="Pay Later Landing Page URL is not Matched.")
    ...
    def test_h_free_shipping_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShipping_url, msg="Free Shipping Landing Page URL is not Matched.")
    ...
    def test_i_getRewarded_icon_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'get_rewarded_url'), get_rewarded_url, msg="Get Rewarded Landing Page URL is not Matched.")
        logger.info(': Assertion Get Rewarded with: ' + get_rewarded_url)
        self.driver.close()
        self.driver.switch_to.window(parent_window)
        logger.info('####  TEST Complete  ####')
    ...
    def test_j_google_play_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'google_play_url'), googleApp_url, msg="Google Play store Page URL Not Matched.")
    ...
    def test_k_apple_store_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'apple_url'), appleApp_url, msg="Apple App Page URL Not Matched.")
    ...
    def test_l_free_shipping_details_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'free_shipping_url'), freeShip_button_url, msg="Free Shipping Page URL Not Matched.")
    ...
    def test_m_Mobile_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'mobile_button_url'), Mobile_button_url, msg="Mobile Button Page URL Not Matched.")
    ...
    def test_n_TV_Audio_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'tv_audio_button_url'), Tv_Audio_button_url, msg="TV & Audio Page URL Not Matched.")
    ...
    def test_o_computing_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'computing_button_url'), Computing_button_url, msg="Computing Page URL Not Matched.")
    ...
    def test_p_appliances_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'appliances_button_url'), Appliance_button_url, msg="Appliance Page URL Not Matched.")
    ...
    def test_q_weekly_offer_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'weekly_offer_button_url'), WeeklyOffer_button_url, msg="Weekly Offer Page URL Not Matched.")
    ...
    def test_r_facebook_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'facebook_url'), Facebook_button_url, msg="Facebook Page URL Not Matched.")
    ...
    def test_s_instagram_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'instagram_url'), Instagram_button_url, msg="Instagram Page URL Not Matched.")
    ...
    def test_t_twitter_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'twitter_url'), Twitter_button_url, msg="Twitter Page URL Not Matched.")
    ...
    def test_u_youtube_button_LandingPage_URL_validation(self):
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_S20FE_configData('EMAILPage', 'youtube_url'), Youtube_button_url, msg="Youtube Page URL Not Matched.")
