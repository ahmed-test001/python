...
class webPage_W_40_S20_S6_S8_Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/Test_InputFile_URLSegment.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'url') in url:
    ...
    def test_a_S20FE_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w40_S20FE_configData('S20FE_GEN_Data', 'url'), WebPage_URL, msg="Web Landing page URL not Matched.")
