...
from Test_w_06_TerraQ_Reserve_T2_extra.test_w06_TerraQ_Reserve_T2_Page import W_06_TerraQ_Reserve_T2_extra_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_06_TerraQ_Reserve_T2_extra_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_06_TerraQ_T2_extra_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
