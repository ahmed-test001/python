...
from Test_w_04_Palette_PO_T4_LastChance_Remail.Page.CreativePage import CreativePage
...
class W_04_Palette_PO_T4_LastChance_Remail_Page_Test(unittest.TestCase):
    ...
    def test_i4_HaveQuestions_icon_LandingPage_URL_validation(self):
        logger.info(': ' + self.test_i4_HaveQuestions_icon_LandingPage_URL_validation.__name__)
        footerPage = FooterLinkPage(self.driver)
        footerPage.get_HaveQuestions_icon_LandingPage_URL_validation()
