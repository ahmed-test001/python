...
class CreativePage(BasePage):
    ...
    def get_EPP_or_NonEPP_verification(self):
        ...
        if "EPP" in subjectlineTxt:
            EPP_WElement = self.wait.until(EC.element_to_be_clickable((By.XPATH,"//*[@src='http://t.info.samsungusa.com/res/samsung/a68a5d7f525e600ebfa4d99bd70f6c99.jpg']")))
            EPP_WElement.is_displayed()
    ...
    def get_CC_pre_header_text_validation(self):
        ...
        elif "N-4_$250" in subjectlineTxt:
            # print(self.SL_250)
            # print(subjectlineTxt)
    ...
    def get_Module2_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/4276d37e26580647b821eaba16bd65ce.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module3_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/153a42ee9e82b47bf454085c1931a31f.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module4_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/70567de7cf7ff8f9e725316c97b0b654.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_pre_order_title_price_validation(self):
        ...
        # print(tradein)
        # try:
            # assert abc == tradein, "Instant Credit amount in Landing Page Banner NOT matching "
            # logger.info(': assertion pre_order_title_ with: ' + abc)
        # except:
            # assert "Pre-order the next Galaxy to get up to $200 instant credit for watches, earbuds, tablets and more. Includes your reservation credit." in tradein, "pre order title price NOT Matching."
    ...
    def get_carrier_instant_credit_validation(self):
        ...
        try:
            ...
            logger.info(': assertion Trade-in price with: 0.00')
    ...
    def get_CC_m1_Conditiontext1_validation(self):
        ...
        footerTxt1 = self.driver.find_element_by_xpath("(//span)[221]").text
    ...
    def get_CC_m2_Conditiontext2_validation(self):
        ...
        footerTxt2 = self.driver.find_element_by_xpath("(//span)[223]").text
        # print(self.SL)
