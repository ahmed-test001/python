...
from Test_w_39_SeroTV.test_w_39_SeroTV_WEB_page import webPage_W_39_SeroTVTest
from Test_w_39_SeroTV.test_w_39_SeroTV_URL_segment import URLSegment_W_39_SeroTVTest
from Test_w_39_SeroTV.test_w_39_SeroTV_HTML_page import HTMLPage_W_39_SeroTVTest
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[HTMLPage_W_39_SeroTVTest, webPage_W_39_SeroTVTest,URLSegment_W_39_SeroTVTest]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_SEROTV_7_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
