...
from Test_w_07_Flash_Sale.test_w07_Flash_Sale_Email_Page import W_07_Flash_Sale_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_07_Flash_Sale_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "_W_07_Flash_Sale_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
