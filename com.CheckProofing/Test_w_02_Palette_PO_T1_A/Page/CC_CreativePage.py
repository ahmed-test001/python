...
class CC_CreativePage(BasePage):
    ...
    def get_CC_pre_header_text_validation(self):
        ...
        subjectlineTxt = self.driver.find_element_by_xpath("(//p[@class='MsoNormal'])[4]/span").text
        self.PH_700 = ExcelUtil(tc_name="").read_from_excel("Generic", 9, 3).strip()
        self.PH_550 = ExcelUtil(tc_name="").read_from_excel("Generic", 9, 4).strip()
        self.PH_350 = ExcelUtil(tc_name="").read_from_excel("Generic", 9, 5).strip()
        self.PH_250 = ExcelUtil(tc_name="").read_from_excel("Generic", 9, 6).strip()
        pheaderTxt = self.driver.find_element_by_xpath("(//a[@target='_blank'])[1]").text
        if "N-4_$250" in subjectlineTxt:
            assert self.PH_250 in pheaderTxt, "Pre Header Text Not Matching"
        elif "N-1_$700" in subjectlineTxt:
            assert self.PH_700 in pheaderTxt, "Pre Header Text Not Matching"
        elif "N-2_$550" in subjectlineTxt:
    ...
    def get_Top_Hero_link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/4e8551a1ea459e7b28088ebc3334ebbc.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module1_link_verification(self):
        ...
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/5890849a0e340ac15587dc89bd36e700.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module2_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/0fbe0a684e40d2833c254155e1cebebd.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module3_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/13ed8344d046fafd4d16c6da28abef2d.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module4_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/ed043844dd7f8faf49f1c03081516eb3.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Module5_link_verification(self):
        ...
        self.url_path = ExcelUtil(tc_name="").read_from_excel("Generic1", 9, 8)
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/3d822dbcdc6bd2749ac05e072f66ffcc.jpg']"))).click()
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        self.driver.switch_to.window(child_window)
        URL = self.driver.current_url
    ...
    def get_Hero_carrier_validation(self):
        logger.info(": ##### Started Hero carrier validation verification #####")
        subjectlineTxt = self.driver.find_element_by_xpath("(//p[@class='MsoNormal'])[4]/span").text
        parent_window = self.driver.current_window_handle
        self.wait.until(EC.element_to_be_clickable((By.XPATH, "//*[@src='http://t.info.samsungusa.com/res/samsung/4e8551a1ea459e7b28088ebc3334ebbc.jpg']"))).click()
        all_windows = self.driver.window_handles
