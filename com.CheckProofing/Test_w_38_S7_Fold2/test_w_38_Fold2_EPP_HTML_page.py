...
class HTMLPage_W_38_Fold2_EPPTest(unittest.TestCase):
    driver = None
    url_list=[]
    method_list_in_Url=[]
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'html_path_Fold2_EPP'))
    ...
    def test_a_pre_subjectLine_text_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'subject_line_Fold2_EPP') in subjectlineTxt
        logger.info(": Pre-Header text assert with : " + ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'subject_line_Fold2_EPP'))
        logger.info('####  TEST Complete  ####')
    ...
    def test_c_get_sub_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url2
        self.driver.close()
    ...
    def test_d_get_galaxyNote20_eligible_tradein_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url3
        self.driver.close()
    ...
    def test_e_CTA_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url5
        self.driver.close()
    ...
    def test_f_get_redeem_credit_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url6
        self.driver.close()
    ...
    def test_g_powerPhone_WorknPlay_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url9
        self.driver.close()
    ...
    def test_h_ownS7_link_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url10
        self.driver.close()
    ...
    def test_x_get_pre_headerlink_validation(self):
        ...
        assert ReadConfig.read_w38_S7_Fold2_configData('Fold2EPP', 'url_Fold2_EPP') in url1
        self.driver.close()
