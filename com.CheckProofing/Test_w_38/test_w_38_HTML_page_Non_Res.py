...
class HTMLPageNonResTest(unittest.TestCase):
    driver = None
    url_list=[]
    method_list_in_Url=[]
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w38_configData('NonRes', 'html_path_NonRes'))
    ...
    def test_a_pre_header_text_validation(self):
        ...
        print(linkT)
        time.sleep(1)
        assert ReadConfig.read_w38_configData('NonRes', 'pre_headertext_NonRes') in linkT
    ...
    def test_b_get_sub_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url2
        self.driver.close()
    ...
    def test_c_get_galaxyNote20_eligible_tradein_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url3
        self.driver.close()
    ...
    def test_f_get_great_pricing_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url6
        self.driver.close()
    ...
    def test_g_get_your_tradein_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url7
        self.driver.close()
    ...
    def test_i_powerPhone_WorknPlay_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url9
        self.driver.close()
    ...
    def test_j_crackedScreen_link_validation(self):
        ...
        parent_window = self.driver.current_window_handle
        linkT = self.driver.find_element_by_xpath("//*[@alt='Buy now']")
        linkT.click()
        time.sleep(3)
        all_windows = self.driver.window_handles
        child_window = [window for window in all_windows if window != parent_window][0]
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url10
        self.driver.close()
    ...
    def test_k_galaxyG_fold2_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url11
        self.driver.close()
    ...
    def test_l_galaxy_TabS7_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url12
        self.driver.close()
    ...
    def test_x_get_pre_headerlink_validation(self):
        ...
        assert ReadConfig.read_w38_configData('NonRes', 'url_NonRes') in url1
        self.driver.close()
