...
class webPageTabS7Test(unittest.TestCase):
    ...
    def setUp(self):
        with open('../TextFolder/Test_InputFile_URLSegment.txt')as f:
            ...
            for url in urls:
                if ReadConfig.read_w38_configData('TabS7_Page', 'tabS7_url') in url:
    ...
    def test_a_verify_page_current_url(self):
        ...
        assert ReadConfig.read_w38_configData('TabS7_Page', 'tabS7_url') in url1
    ...
    def test_b_verify_promo_credit_banner(self):
        ...
        time.sleep(2)
        assert "Pre-order Galaxy Tab S7 or Tab S7+ today and save up to $450 with enhanced trade-in values" in bannerText
    ...
    def test_c_verify_tradein_value(self):
        ...
        assert ReadConfig.read_w38_configData('TabS7_Page', 'Device_Tradein_Value') in tradeinPrice
    ...
    def test_d_verify_deviceBrand_Name(self):
        ...
        try:
            ...
            assert ReadConfig.read_w38_configData('TabS7_Page', 'device_Brand') in deviceBrand
    ...
    def test_e_verify_deviceType_Name(self):
        ...
        try:
            ...
            assert ReadConfig.read_w38_configData('TabS7_Page', 'Device_Name') in deviceName
    ...
    def test_f_verify_tradein_discount_price(self):
        ...
        try:
            ...
            assert ReadConfig.read_w38_configData('TabS7_Page', 'Device_Tradein_Discount_Value') in discountPrice
    ...
    def test_g_verify_total_device_price(self):
        ...
        assert ReadConfig.read_w38_configData('TabS7_Page', 'Total_Price') in totalPrice
    ...
    def test_h_verify_eligible_price(self):
        ...
        assert ReadConfig.read_w38_configData('TabS7_Page', 'Eligible_Tradein_Value') in eligiblePrice
    ...
    def test_i_verify_list_device_price(self):
        ...
        assert ReadConfig.read_w38_configData('TabS7_Page', 'list_device_price') in listdevicePrice
        logger.info(': assertion complete with: ' + listdevicePrice)
        logger.info('####  TEST Complete  ####')

    @classmethod
    def test_j_verify_tabS7_preOrder_button(self):
        logger.info(': ' + self.test_j_verify_tabS7_preOrder_button.__name__ + "\n #####  Starting TEST  ##### ")
        time.sleep(3)
        preOrderText1 = self.driver.find_element_by_xpath("(//div[@class ='button  PRE-ORDER'])[1]").text
        preOrderText2 = self.driver.find_element_by_xpath("(//div[@class ='button  PRE-ORDER'])[2]").text
        assert ReadConfig.read_w38_configData('TabS7_Page', 'preOrderText') in preOrderText1
        assert ReadConfig.read_w38_configData('TabS7_Page', 'preOrderText') in preOrderText2
