...
class HTMLPageVRZTest(unittest.TestCase):
    driver = None
    url_list=[]
    method_list_in_Url=[]
    ...
    def setUp(self):
        ...
        self.driver.get(ReadConfig.read_w38_configData('VRZ', 'html_path_VRZ'))
    ...
    def test_a_pre_header_text_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'pre_headertext_VRZ') in linkT
    ...
    def test_b_get_sub_pre_header_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url2
        self.driver.close()
    ...
    def test_c_get_galaxyNote20_eligible_tradein_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url3
        self.driver.close()
    ...
    def test_d_get_galaxyNote20_50prcntOff_with_carrier_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url4
        self.driver.close()
    ...
    def test_e_redeem_instant_credit_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url5
        self.driver.close()
    ...
    def test_f_get_great_pricing_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url6
        self.driver.close()
    ...
    def test_g_get_your_tradein_options_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url7
        self.driver.close()
    ...
    def test_h_50prcntOff_unlock_galaxyNote20_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url8
        self.driver.close()
    ...
    def test_i_powerPhone_WorknPlay_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url9
        self.driver.close()
    ...
    def test_j_crackedScreen_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url10
        self.driver.close()
    ...
    def test_k_galaxyG_fold2_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url11
        self.driver.close()
    ...
    def test_l_galaxy_TabS7_link_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url12
        self.driver.close()
    ...
    def test_x_get_pre_headerlink_validation(self):
        ...
        assert ReadConfig.read_w38_configData('VRZ', 'url_VRZ') in url1
        self.driver.close()
