...
from Test_Campaign_2021.scripts.python.Page.UrlSegmentPage import URLSegmentPage
...
class ModuleURLPage(BasePage):
    ...
    def get_pre_header_link_validation(self, sheet_name, sheet_row,sheet_column,xpath_loc):
        ...
        # with open('../../URL_Folder/UniqueUrl.txt', 'w')as f:f.writelines(URL)
        with open(ReadConfig.readFilePathData('FilePaths', 'module_unique_url'), 'w')as f:f.writelines(URL)
