...
from Test_Campaign_2021.scripts.python.Page.extract_images import extract_images
from Test_Campaign_2021.scripts.python.Page.extract_text import extract_text
from Test_Campaign_2021.scripts.python.Util_Data import ReadConfig
from creative_analyzer_final_copy.scripts.python.custom_functions import check_hyper_links_key_value, check_common_key_value, check_key_exist
...
def extract_hyper_links(link, filename):
    ...
    chromedriver = ReadConfig.readconfigData('paths', 'chromedriver')
    d_cols = {}
