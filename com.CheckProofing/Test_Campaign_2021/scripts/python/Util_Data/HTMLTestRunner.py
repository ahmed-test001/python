...
class Template_mixin(object):
    ...
    DEFAULT_TITLE = 'Unit Test_Image Report'
    DEFAULT_DESCRIPTION = ''
...
"""  # variables: (title, generator, stylesheet, heading, report, ending, chart_script)
    ...
    <script type="text/javascript">
        ...
        var option = {
            ...
            series : [
                {
                    name: 'Test_Image execution',
                    type: 'pie',
                    radius : '60%%',
                    center: ['50%%', '60%%'],
                    data:[
                        {value:%(Pass)s, name:'Passed'},
                        {value:%(fail)s, name:'Failed'},
...
"""  # variables: (name, value)
    ...
    <div class="btn-group btn-group-sm">
        <a class="btn btn-primary" onclick='javascript:showCase(0)'>Passed{ %(passrate)s }</a>
        ...
        <a class="btn btn-info" onclick='javascript:showCase(3)'>Total{ %(count)s }</a>
    </div>
    <p></p>
    <table id='result_table' class="table table-bordered">
        ...
        <tr id='header_row'>
            <td>Test_Image Suite/Test_Image Case</td>
            <td>Total</td>
            <td>Passed</td>
            <td>Failed</td>
            <td>Error</td>
...
"""  # variables: (test_list, count, Pass, fail, error)
    ...
    <tr class='%(style)s'>
        ...
        <td>%(fail)s</td>
        <td>%(error)s</td>
        <td><a href="javascript:showClassDetail('%(cid)s',%(count)s)">Logs</a></td>
    </tr>
...
class HTMLTestRunner(Template_mixin):
    ...
    def getReportAttributes(self, result):
        ...
        status = []
        if result.success_count: status.append(u'Passed %s' % result.success_count)
