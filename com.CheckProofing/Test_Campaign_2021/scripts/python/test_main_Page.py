...
from Test_Campaign_2021.scripts.python.test_proofing_Page import Proofing_Page_Test
from Test_Campaign_2021.scripts.python.Util_Data.HTMLTestRunner import HTMLTestRunner
from Test_Campaign_2021.scripts.python.Util_Data import ReadConfig
# DOWNLOAD_PATH = "../../HTML_Report/"
DOWNLOAD_PATH = ReadConfig.readFilePathData('FilePaths', 'HTML_Report')
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "_2021_Proofing_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
