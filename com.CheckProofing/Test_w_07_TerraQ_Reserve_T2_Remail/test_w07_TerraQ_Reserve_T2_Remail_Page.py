...
from Test_w_07_TerraQ_Reserve_T2_Remail.Page.CreativePage import CreativePage
...
class W_06_TerraQ_Reserve_T2_Test(unittest.TestCase):
    ...
    def test_a4_Hero_image_Text_verification(self):
        ...
        ccpage=CreativePage(self.driver)
        ccpage.get_Hero_image_Text_validation()
    ...
    #     ccpage=CreativePage(self.driver)
    #     ccpage.get_Hero_image_SC_Text_validation()
    ...
    def test_a7_Top_Hero_SC_text_verification(self):
        ...
        ccpage=CreativePage(self.driver)
        ccpage.get_Hero_SC_Text_validation()
