...
from Test_w_07_TerraQ_Reserve_T2_Remail.test_w07_TerraQ_Reserve_T2_Remail_Page import W_07_TerraQ_Reserve_T2_Remail_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_07_TerraQ_Reserve_T2_Remail_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_07_TerraQ_T2_Remail_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
