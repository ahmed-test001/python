...
from Test_w_04_Palette_PO_Launch_T1.Page.CreativePage import CreativePage
...
class W_05_Palette_PO_Launch_T2_Page_Test(unittest.TestCase):
    ...
    def test_a2_Hero_HL_verification(self):
        logger.info(': ' + self.test_a2_Hero_HL_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_Hero_HL_verification()
    ...
    # def test_c4_JetStick_Module_link_Validation(self):
    #     logger.info(': ' + self.test_c4_JetStick_Module_link_Validation.__name__)
    #     ccpage=CreativePage(self.driver)
    #     ccpage.get_jetStick_Module_link_verification()
