...
from Test_w_04_Palette_PO_T3.Page.CreativePage import CC_CreativePage
...
class W_04_Palette_PO_T3_Page_Test(unittest.TestCase):
    ...
    # def test_d1_Device_Option_Validation(self):
    #     logger.info(': ' + self.test_d1_Device_Option_Validation.__name__)
    #     ccpage=CC_CreativePage(self.driver)
    #     ccpage.get_DeviceOption_verification()
