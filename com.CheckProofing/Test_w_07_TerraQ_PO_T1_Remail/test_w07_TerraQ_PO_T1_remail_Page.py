...
from Test_w_07_TerraQ_PO_T1.Page.CC_CreativePage import CC_CreativePage
...
class W_07_TerraQ_PO_T1_remail_Test(unittest.TestCase):
    ...
    def test_a4_Hero_HL_Text_verification(self):
        logger.info(': ' + self.test_a4_Hero_HL_Text_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Hero_HL_Text_validation()

    def test_a5_Hero_SC_Text_verification(self):
        logger.info(': ' + self.test_a5_Hero_SC_Text_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_CC_kv_sc_text_validation()
    ...
    def test_a7_Module2_link_verification(self):
        logger.info(': ' + self.test_a7_Module2_link_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Module2_link_validation()
