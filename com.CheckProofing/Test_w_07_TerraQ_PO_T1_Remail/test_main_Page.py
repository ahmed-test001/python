...
from Test_w_07_TerraQ_PO_T1_Remail.test_w07_TerraQ_PO_T1_remail_Page import W_07_TerraQ_PO_T1_remail_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_07_TerraQ_PO_T1_remail_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_07_TerraQ_PO_T1_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
