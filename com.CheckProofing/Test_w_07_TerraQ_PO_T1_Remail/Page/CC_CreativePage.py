    ...
    def get_URL_Segment_validation(self):
        ...
        with open('../OutputT/OutResult.json', 'r')as jsonfile:
            ...
            if "marsLinkCategory" in readdata['check_list'][0]:
                if ExcelUtil(tc_name="").read_from_excel("urlsegment", 7, 2) in readdata['check_list'][0]['marsLinkCategory']:
                    assert ExcelUtil(tc_name="").read_from_excel("urlsegment", 7, 2) in readdata['check_list'][0]['marsLinkCategory'], "marsLinkCategory Not Matching."
                    logger.info(": marsLinkCategory==" + ExcelUtil(tc_name="").read_from_excel("urlsegment", 7, 2))
                else:
            ...
            if "cid" in readdata['check_list'][0]:
                if ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 2) in readdata['check_list'][0]['cid']:
                    assert ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 2) in readdata['check_list'][0]['cid'], "cid Not Matching."
                    logger.info(": cid==" + ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 2))
                elif ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 3) in readdata['check_list'][0]['cid']:
                    assert ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 3) in readdata['check_list'][0]['cid'], "cid Not Matching."
                    logger.info(": cid==" + ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 3))
                elif ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 4) in readdata['check_list'][0]['cid']:
                    assert ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 4) in readdata['check_list'][0]['cid'], "cid Not Matching."
                    logger.info(": cid==" + ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 4))
                elif ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 5) in readdata['check_list'][0]['cid']:
                    assert ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 5) in readdata['check_list'][0]['cid'], "cid Not Matching."
                    logger.info(": cid==" + ExcelUtil(tc_name="").read_from_excel("urlsegment", 8, 5))
                else:
