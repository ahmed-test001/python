...
from Test_w_40_GW3.WriteConfig_GW3 import writeData
from Test_w_40_GW3.test_w_40_GW3_HTML_page import HTMLPage_W_40_GW3Test
from Test_w_40_GW3.test_w_40_GW3_URL_segment import URLSegment_W_40_GW3Test
from Test_w_40_GW3.test_w_40_GW3_WEB_page import webPage_W_40_GW3Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests =[writeData, HTMLPage_W_40_GW3Test, webPage_W_40_GW3Test, URLSegment_W_40_GW3Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_WEARABLE_1_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
