...
class webPage_W_40_GW3Test(unittest.TestCase):
    ...
    def test_a_SeroTV_WebLandingPage_URL_validation(self):
        ...
        self.assertEqual(ReadConfig.read_w40_Wearable_configData('WearableData', 'url'), SeroTV_WebPage_URL, msg="Sero TV Web Landing page URL not Matched.")
    ...
    def test_b_SeroTV_price_validation_BuyNow_TopButton(self):
        ...
        self.assertIn(ReadConfig.read_w40_Wearable_configData('WearableData', 'total_tv_price'), SeroTV_price_Text, msg="Samsung Sero Tv Price is not matching from samsung CART Total Page ")
        logger.info(": Successfully verified Samsung Sero Tv Total Price: " + ReadConfig.read_w40_Wearable_configData('WearableData', 'total_tv_price'))
        time.sleep(5)
        try:
        ...
        time.sleep(5)
        self.assertIn(ReadConfig.read_w40_Wearable_configData('WearableData', 'saving_price'), TotalPrice, msg="Sero TV Total saving value is not matching in samsung Web Cart Page ")
        logger.info(": Successfully verified SeroTV Total saving from samsung CART Total Page is: " + ReadConfig.read_w40_Wearable_configData('WearableData', 'saving_price'))
        logger.info('####  TEST Complete  ####')
