...
from Test_w_04_SuperBowl_Offers.Page.CreativePage import CreativePage
...
class W_04_SuperBowl_Offers_Page_Test(unittest.TestCase):
    ...
    def test_c1_Hero_link_verification(self):
        logger.info(': ' + self.test_c1_Hero_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_Top_Hero_link_validation()

    def test_c2_8k_QLED_TV_link_verification(self):
        logger.info(': ' + self.test_c2_8k_QLED_TV_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_8k_QLED_TV_link_verification()

    def test_c3_Terrace_TV_link_verification(self):
        logger.info(': ' + self.test_c3_Terrace_TV_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_Terrace_TV_link_verification_link_verification()

    def test_c4_Frame_TV_link_verification(self):
        logger.info(': ' + self.test_c4_Frame_TV_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_Frame_TV_link_verification_link_verification()

    def test_c5_Soundbar_QSeries_link_verification(self):
        logger.info(': ' + self.test_c5_Soundbar_QSeries_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_Soundbar_QSeries_link_verification()

    def test_d6_FooterHero_link_verification(self):
        logger.info(': ' + self.test_d6_FooterHero_link_verification.__name__)
        ccpage = CreativePage(self.driver)
        ccpage.get_FooterHero_link_verification()
