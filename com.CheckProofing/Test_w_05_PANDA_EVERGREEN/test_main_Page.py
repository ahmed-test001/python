...
from Test_w_05_PANDA_EVERGREEN.test_w05_PANDA_EVERGREEN_Page import W_05_PANDA_EVERGREEN_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_05_PANDA_EVERGREEN_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_05_PANDA_EVERGREEN_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
