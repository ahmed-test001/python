...
from Test_w_05_PANDA_EVERGREEN.Page.CC_CreativePage import CC_CreativePage
...
class W_05_PANDA_EVERGREEN_Page_Test(unittest.TestCase):
    ...
    def test_a5_Hero_Text_verification(self):
        logger.info(': ' + self.test_a5_Hero_Text_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Hero_Text_validation()
