...
from Test_w_03_Flash_Sale_HA.Page.CreativePage import CreativePage
...
class W_03_Flash_Sale_HA_Page_Test(unittest.TestCase):
    ...
    def test_a4_Hero_link_verification(self):
        logger.info(': ' + self.test_a4_Hero_link_verification.__name__)
        ccpage=CreativePage(self.driver)
