...
from Test_w_03_Flash_Sale_HA.test_w03_Flash_Sale_HA_Email_Page import W_03_Flash_Sale_HA_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_03_Flash_Sale_HA_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_03_Flash_Sale_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
