...
from Test_w_02_Palette_PO_T1_A.test_w02_Palette_PO_T1_A_Email_Page import W_02_Palette_PO_T1_A_Page_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        tests = [W_02_Palette_PO_T1_A_Page_Test]
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "1_W_03_Palette_PO_T2_Report_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
