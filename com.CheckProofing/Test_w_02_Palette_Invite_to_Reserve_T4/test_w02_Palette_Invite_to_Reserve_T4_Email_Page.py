...
from Test_w_02_Palette_Invite_to_Reserve_T4.Page.CC_CreativePage import CC_CreativePage
...
class W_02_Palette_Invite_to_Reserve_T2_Page_Test(unittest.TestCase):
    ...
    def test_a7_Hero_link_verification(self):
        logger.info(': ' + self.test_a7_Hero_link_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Top_Hero_link_validation()

    def test_c1_Module2_RemindME_link_verification(self):
        logger.info(': ' + self.test_c1_Module2_RemindME_link_verification.__name__)
        ccpage=CC_CreativePage(self.driver)
        ccpage.get_Module2_RemindME_link_verification()

    def test_c2_Module2_SubCopyTex_Validation(self):
        logger.info(': ' + self.test_c2_Module2_SubCopyTex_Validation.__name__)
        ccpage=CC_CreativePage(self.driver)
