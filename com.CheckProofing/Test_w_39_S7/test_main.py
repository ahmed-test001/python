...
from Test_w_39_S7.test_w_39_S7_EPP_HTML_page import HTMLPage_W_39_S7_EPP_Test
from Test_w_39_S7.test_w_39_S7_EPP_URL_segment import URLSegment_W_39_S7_EPP_Test
from Test_w_39_S7.test_w_39_S7_EPP_WEB_page import webPage_W_39_S7_EPP_Test
from Test_w_39_S7.test_w_39_S7_GEN_HTML_page import HTMLPage_W_39_S7_Gen_Test
from Test_w_39_S7.test_w_39_S7_GEN_URL_segment import URLSegment_W_39_S7_Gen_Test
from Test_w_39_S7.test_w_39_S7_GEN_WEB_page import webPage_W_39_S7_Gen_Test
...
class MainTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        # tests =[HTMLPage_W_39_S7_Gen_Test, webPage_W_39_S7_Gen_Test,URLSegment_W_39_S7_Gen_Test] #tab s7 GEN
        tests = [HTMLPage_W_39_S7_EPP_Test, webPage_W_39_S7_EPP_Test, URLSegment_W_39_S7_EPP_Test] #tab s7 EPP
        ...
        report_file = os.path.join(DOWNLOAD_PATH, "TestReport_TABS7_EPP_6_{}.html".format(datetime.datetime.now().strftime("%Y_%m_%d-%I_%M_%S_%p")))
